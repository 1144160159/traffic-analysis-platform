...
-- Manifest-v2 single-node development table. It intentionally uses
-- ReplacingMergeTree rather than pretending this compose environment supplies
-- production Keeper/replication; the carrier startup attestor therefore still
-- fails closed here while DDL/binder integration tests can exercise all 29
-- columns.
