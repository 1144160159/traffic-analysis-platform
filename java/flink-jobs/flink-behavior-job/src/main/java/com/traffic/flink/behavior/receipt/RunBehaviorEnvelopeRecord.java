...
/**
 * run envelope(analysis.envelopes.v1,JSON)输入视图——与 flink-feature-job
 * RunEnvelopeRecord 同契约(跨作业共享信封 schema;本模块独立镜像以避免跨模块
 * 打包耦合)。
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public final class RunBehaviorEnvelopeRecord implements java.io.Serializable {
    ...
    public static final class Event implements java.io.Serializable {
        private static final long serialVersionUID = 1L;
        @JsonProperty("community_id") private String communityId;
        @JsonProperty("flow_id") private String flowId;
        @JsonProperty("ts_start") private long tsStart;
        @JsonProperty("ts_end") private long tsEnd;
        @JsonProperty("packets_fwd") private long packetsFwd;
        @JsonProperty("packets_bwd") private long packetsBwd;
        @JsonProperty("bytes_fwd") private long bytesFwd;
        @JsonProperty("bytes_bwd") private long bytesBwd;
        @JsonProperty("duration_ms") private long durationMs;
        @JsonProperty("direction") private String direction;
        @JsonProperty("pps") private double pps;
        @JsonProperty("bps") private double bps;
        @JsonProperty("tcp_flags_fwd") private long tcpFlagsFwd;
        @JsonProperty("tcp_flags_bwd") private long tcpFlagsBwd;
        @JsonProperty("tos") private long tos;
        @JsonProperty("subflow_count") private long subflowCount;
        @JsonProperty("tuple") private Tuple tuple;
        @JsonProperty("pktlen") private Stat pktlen;
        @JsonProperty("iat") private Stat iat;
        @JsonProperty("active") private Stat active;
        @JsonProperty("idle") private Stat idle;
        @JsonProperty("feature_observation") private FeatureObservation featureObservation;
        ...
        public FeatureObservation featureObservation() { return featureObservation; }
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class FeatureObservation implements java.io.Serializable {
        private static final long serialVersionUID = 1L;
        @JsonProperty("transport_security") private long transportSecurity;
        @JsonProperty("tls_version") private String tlsVersion;
        @JsonProperty("ja3") private String ja3;
        @JsonProperty("ja4") private String ja4;
        @JsonProperty("sni") private String sni;
        @JsonProperty("payload_observed_bytes") private long payloadObservedBytes;
        @JsonProperty("missing_fields") private java.util.List<String> missingFields;
        public long transportSecurity() { return transportSecurity; }
        public String tlsVersion() { return tlsVersion; }
        public String ja3() { return ja3; }
        public String ja4() { return ja4; }
        public String sni() { return sni; }
        public long payloadObservedBytes() { return payloadObservedBytes; }
        public java.util.List<String> missingFields() { return missingFields == null ? java.util.List.of() : missingFields; }
    }
