-- T1-M03-N016: additive file-restoration authority and crash reconciliation.
-- This is separate from PCAP-cut tasks. Runtime services must never CREATE or
-- ALTER these tables. Rollback disables admission and retains every row/object.
BEGIN;
