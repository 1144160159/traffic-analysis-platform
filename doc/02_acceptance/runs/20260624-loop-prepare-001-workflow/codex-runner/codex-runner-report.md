# Codex Runner Report: CLE-P0-DLQ-001

- status: `CODEX_RUNNER_PLANNED`
- execute_requested: `False`
- command_template: `codex exec --model gpt-5 --sandbox read-only --output-schema doc/02_acceptance/runs/20260624-loop-prepare-001-workflow/patch-runner/codex-output-schema.json 'Read and follow the high-risk Codex patch request at {prompt}. Return only output matching the provided schema. Highlight contract, security, evidence, and rollback risks.'`
- model_profile: `doc/02_acceptance/runs/20260624-loop-prepare-001-workflow/model-profile/model-profile.json`
