# Codex Implementation Prompt: CLE-P0-DLQ-001

Use `doc/02_acceptance/runs/20260624-loop-prepare-001-workflow/implementation/implementation-brief.md` as the implementation boundary for run `20260624-loop-prepare-001-workflow`.
