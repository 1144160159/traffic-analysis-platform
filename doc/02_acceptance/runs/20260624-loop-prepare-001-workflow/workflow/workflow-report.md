...
- selected_task: `CLE-P0-DLQ-001` DLQ replay API、审批、审计、幂等验证
...
## Stage Flow
- `scout.py` skipped: using existing context dir doc/02_acceptance/runs/20260624-loop-prepare-001-scout/context
- `guide.py` skipped: using existing guidance doc/02_acceptance/runs/20260624-loop-prepare-001-guidance/guidance/guidance.json
- `design.py` exit `0`
