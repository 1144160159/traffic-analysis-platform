...
- Run ID: `20260630-project-completion-audit-r20-release-r68-detection-quality-guard`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r20-release-r68-detection-quality-guard/live-project-completion-audit-20260630-project-completion-audit-r20-release-r68-detection-quality-guard.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r20-release-r68-detection-quality-guard/live-project-completion-audit-20260630-project-completion-audit-r20-release-r68-detection-quality-guard-summary.json`
...
- trial_third_party_signoff: signoff template still contains placeholders or pending signature markers; readiness_run_id=20260630-third-party-signoff-readiness-r8-release-r68-detection-quality-guard readiness_result=pass template_tbd_count=159 upstream_blocked_or_nonpass_inputs=5 readiness_release_run_id=20260630-release-manifest-r68-detection-quality-guard current_release_run_id=20260630-release-manifest-r68-detection-quality-guard (`doc/02_acceptance/08-third-party/user-acceptance-signoff.md`)
