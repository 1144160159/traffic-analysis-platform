...
- Run ID: `20260702-ui-visual-interaction-preflight-r24-smoke-config-gate`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r24-smoke-config-gate/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension target was unavailable during the prior capture attempt; this run verifies repository/live smoke-token prerequisites and keeps visual/interaction evidence blocked until Desktop Chrome can provide real 1920x1080 captures.
