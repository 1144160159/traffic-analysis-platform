...
- run_id: `mvp-26-release-with-workspace-isolation`
...
- workspace_isolation: `doc/02_acceptance/runs/mvp-26-workspace-isolation-plan/workspace-isolation/isolation-plan.json`
- workspace_isolation_status: `WORKSPACE_ISOLATION_DEGRADED`
- executor_pool: `doc/02_acceptance/runs/mvp-26-executor-pool-isolated/executor-pool/executor-pool-summary.json`
