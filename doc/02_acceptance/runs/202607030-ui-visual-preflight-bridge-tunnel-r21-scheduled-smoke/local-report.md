...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r21-scheduled-smoke`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r21-scheduled-smoke/ui-visual-interaction-matrix.json`
