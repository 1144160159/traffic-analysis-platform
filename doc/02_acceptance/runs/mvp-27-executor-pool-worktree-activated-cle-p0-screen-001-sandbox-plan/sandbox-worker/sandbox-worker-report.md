...
- run_id: `mvp-27-executor-pool-worktree-activated-cle-p0-screen-001-sandbox-plan`
...
## Sandbox Plans
- `CLE-P0-SCREEN-001` -> `mvp-27-executor-pool-worktree-activated-cle-p0-screen-001-sandbox-plan-cle-p0-screen-001-sandbox` exit `0` status `SANDBOX_PLAN_READY` workspace `doc/02_acceptance/runs/.loop/worktrees/mvp-27-executor-pool-worktree-activated/cle-p0-screen-001`
