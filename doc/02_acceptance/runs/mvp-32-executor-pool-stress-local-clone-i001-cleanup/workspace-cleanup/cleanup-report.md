...
- run_id: `mvp-32-executor-pool-stress-local-clone-i001-cleanup`
- status: `WORKSPACE_CLEANUP_COMPLETED`
- source: `doc/02_acceptance/runs/mvp-32-executor-pool-stress-local-clone-i001/executor-pool/workspace-isolation.json`
- execute_requested: `True`
- force: `False`
- workspaces: `1`

## Workspaces
- `CLE-P0-SCREEN-001` -> `doc/02_acceptance/runs/.loop/worktrees/mvp-32-executor-pool-stress-local-clone-i001/cle-p0-screen-001` backend `local-clone` exists `True` registered `False` dirty `False`
