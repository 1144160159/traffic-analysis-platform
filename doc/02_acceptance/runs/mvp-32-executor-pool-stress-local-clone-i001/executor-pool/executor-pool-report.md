...
- run_id: `mvp-32-executor-pool-stress-local-clone-i001`
...
## Children
- `CLE-P0-SCREEN-001` -> `mvp-32-executor-pool-stress-local-clone-i001-cle-p0-screen-001-sandbox-plan` exit `0` status `SANDBOX_WORKER_PLANNED` workspace `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/.loop/worktrees/mvp-32-executor-pool-stress-local-clone-i001/cle-p0-screen-001`
