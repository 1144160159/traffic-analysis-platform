...
- generated_at: `2026-06-24T02:13:50`
- run_total: `102`
- queue_total: `1`
- queue_counts: `{'done': 1}`
- lock_present: `False`
...
## Latest Runs
- `mvp-17-service-run-preflight-cycle1-i1` `guidance` `GUIDANCE_GENERATED`
- `mvp-17-service-run-preflight-cycle1-i1-scheduler` `scheduler` `LOCK_ACQUIRED`
- `mvp-17-service-run-preflight-cycle1-i1-worker` `worker` `WORKER_COMPLETED`
- `mvp-17-service-run-preflight-cycle1-i1-scout` `context_scout` `CONTEXT_SCOUTED`
- `mvp-17-post-preflight-scout` `context_scout` `CONTEXT_SCOUTED`
- `mvp-17-service-once-preflight` `service` `SERVICE_ONCE_COMPLETED`
- `mvp-17-service-once-preflight-daemon` `daemon` `DAEMON_COMPLETED`
- `mvp-17-service-once-preflight-daemon-i1` `guidance` `GUIDANCE_GENERATED`
- `mvp-17-service-once-preflight-daemon-i1-metrics` `metrics` `METRICS_COLLECTED`
