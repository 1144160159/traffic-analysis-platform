...
- run_id: `mvp-25-executor-pool-http-queue-cle-p0-screen-001-sandbox-plan`
...
## Sandbox Plans
- `CLE-P0-SCREEN-001` -> `mvp-25-executor-pool-http-queue-cle-p0-screen-001-sandbox-plan-cle-p0-screen-001-sandbox` exit `0` status `SANDBOX_PLAN_READY`
