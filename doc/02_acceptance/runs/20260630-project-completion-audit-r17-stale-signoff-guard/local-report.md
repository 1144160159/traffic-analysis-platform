...
- Run ID: `20260630-project-completion-audit-r17-stale-signoff-guard`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r17-stale-signoff-guard/live-project-completion-audit-20260630-project-completion-audit-r17-stale-signoff-guard.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r17-stale-signoff-guard/live-project-completion-audit-20260630-project-completion-audit-r17-stale-signoff-guard-summary.json`
...
| trial_third_party_signoff | blocked | stale_release | `doc/02_acceptance/08-third-party/readiness/third-party-signoff-readiness-latest.json` |
...
- trial_third_party_signoff: third-party readiness was generated against a stale release manifest; readiness_run_id=20260630-third-party-signoff-readiness-r5-owner-classification readiness_result=pass template_tbd_count=159 upstream_blocked_or_nonpass_inputs=5 readiness_release_run_id=20260630-release-manifest-r65-signoff-prefill current_release_run_id=20260630-release-manifest-r66-signoff-owner-classification (`doc/02_acceptance/08-third-party/readiness/third-party-signoff-readiness-latest.json`)
