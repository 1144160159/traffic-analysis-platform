...
- Run ID: `20260702-ui-visual-interaction-preflight-r10-desktop-screenshot-viewport-blocked`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r10-desktop-screenshot-viewport-blocked/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Codex Desktop Chrome extension backend is available; list_tabs and open_url passed; raw Desktop Chrome tab.screenshot uploaded login evidence to latest/login, but captured size is 2559x1271 with viewport 2560x1271 DPR 1.5, window.resizeTo is unavailable, so required uncropped 1920x1080 visual capture remains blocked.
