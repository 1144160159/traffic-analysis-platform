...
- Run ID: `20260702-ui-visual-interaction-preflight-r39-viewport-probe-normalized`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r39-viewport-probe-normalized/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: codex-desktop-node-repl desktop_chrome_list_tabs returned Transport closed in current continuation; Chrome extension backend unavailable, iab fallback forbidden
