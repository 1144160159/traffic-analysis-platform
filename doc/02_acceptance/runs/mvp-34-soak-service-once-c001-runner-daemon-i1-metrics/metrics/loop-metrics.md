...
- generated_at: `2026-06-24T06:48:11`
- run_total: `255`
- queue_total: `1`
- queue_counts: `{'done': 1}`
...
- `mvp-33-executor-pool-stress-local-clone-i001-cle-p0-screen-001-sandbox-plan` `sandbox_worker` `SANDBOX_WORKER_PLANNED`
- `mvp-33-executor-pool-stress-local-clone-i001-cle-p0-screen-001-sandbox-plan-cle-p0-screen-001-sandbox` `sandbox_plan` `SANDBOX_PLAN_READY`
- `mvp-32-release-with-executor-pool-stress` `release_freeze` `RELEASE_FROZEN`
- `mvp-32-executor-pool-stress-local-clone` `executor_pool_stress` `EXECUTOR_POOL_STRESS_COMPLETED`
- `mvp-32-executor-pool-stress-local-clone-i002-cleanup` `workspace_cleanup` `WORKSPACE_CLEANUP_COMPLETED`
