...
- Run ID: `20260702-ui-visual-interaction-preflight-r23-config-docsync`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r23-config-docsync/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension target became temporarily unavailable after prior tab-control timeouts; live and repo Web UI manifests keep DESKTOP_SMOKE_TOKEN_ENABLED=true, and latest accepted interaction evidence remains login/alerts/dashboard/screen. Visual gate still requires reliable browser-generated 1920x1080 screenshots.
