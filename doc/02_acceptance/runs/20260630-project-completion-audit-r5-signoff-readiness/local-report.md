...
- Run ID: `20260630-project-completion-audit-r5-signoff-readiness`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r5-signoff-readiness/live-project-completion-audit-20260630-project-completion-audit-r5-signoff-readiness.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r5-signoff-readiness/live-project-completion-audit-20260630-project-completion-audit-r5-signoff-readiness-summary.json`
...
- trial_third_party_signoff: signoff template still contains TBD placeholders; readiness_run_id=20260630-third-party-signoff-readiness-r1 readiness_result=pass template_tbd_count=185 upstream_blocked_or_nonpass_inputs=5 (`doc/02_acceptance/08-third-party/user-acceptance-signoff.md`)
