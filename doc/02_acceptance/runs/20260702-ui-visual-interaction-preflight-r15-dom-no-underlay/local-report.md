...
- Run ID: `20260702-ui-visual-interaction-preflight-r15-dom-no-underlay`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r15-dom-no-underlay/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension wrapper remains unavailable in this session; login page is React DOM/CSS without target-derived underlay, local Playwright capture exists but pixel diff still fails 1:1 threshold.
