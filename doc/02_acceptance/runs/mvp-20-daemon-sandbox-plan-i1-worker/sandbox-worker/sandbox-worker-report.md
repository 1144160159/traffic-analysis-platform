...
- run_id: `mvp-20-daemon-sandbox-plan-i1-worker`
...
## Sandbox Plans
- `CLE-P0-SCREEN-001` -> `mvp-20-daemon-sandbox-plan-i1-worker-cle-p0-screen-001-sandbox` exit `0` status `SANDBOX_PLAN_READY`
