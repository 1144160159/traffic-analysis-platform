...
- run_id: `mvp-44-k8s-bootstrap-queue-service-apply`
- status: `K8S_BOOTSTRAP_BLOCKED`
- namespace: `traffic-analysis`
- deploy_dir: `doc/02_acceptance/runs/mvp-44-queue-service-k8s-deploy-plan-pv/deploy`
- execute_requested: `True`
- execute_gate_accepted: `True`
- token_env_present: `True`

## Findings
- `blocker` `K8S_BOOTSTRAP_APPLY_FAILED`: rollout_status exited 1.
