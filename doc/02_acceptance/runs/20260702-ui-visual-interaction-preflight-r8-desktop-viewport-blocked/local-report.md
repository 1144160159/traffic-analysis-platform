...
- Run ID: `20260702-ui-visual-interaction-preflight-r8-desktop-viewport-blocked`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r8-desktop-viewport-blocked/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Chrome extension target is available, but wrapper openTabs/cleanup and raw screenshot/CDP 1920x1080 capture timed out; latest probe recorded in desktop-chrome-viewport-probe-latest.json.
