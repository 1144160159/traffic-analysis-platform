...
| ui_visual_interaction | Frontend / QA | visual_diff_blocked_and_interaction_partial | use the generated Desktop capture plan, fix Desktop Chrome capture viewport to 1920x1080, regenerate 30 real React page screenshot diffs, record the missing route-specific interaction.json files, then rerun the UI visual interaction gate |
