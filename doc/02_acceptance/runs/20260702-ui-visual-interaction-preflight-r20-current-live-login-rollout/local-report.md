...
- Run ID: `20260702-ui-visual-interaction-preflight-r20-current-live-login-rollout`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r20-current-live-login-rollout/ui-visual-interaction-matrix.json`
