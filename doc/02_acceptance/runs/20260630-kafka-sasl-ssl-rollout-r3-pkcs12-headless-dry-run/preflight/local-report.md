...
Run: `20260630-kafka-sasl-ssl-rollout-r3-pkcs12-headless-dry-run-preflight`
...
- `doc/02_acceptance/runs/20260630-kafka-sasl-ssl-rollout-r3-pkcs12-headless-dry-run/preflight/live-kafka-security-rollout-preflight-20260630-kafka-sasl-ssl-rollout-r3-pkcs12-headless-dry-run-preflight-summary.json`
- `doc/02_acceptance/runs/20260630-kafka-sasl-ssl-rollout-r3-pkcs12-headless-dry-run/preflight/live-kafka-security-rollout-preflight-20260630-kafka-sasl-ssl-rollout-r3-pkcs12-headless-dry-run-preflight.ndjson`
