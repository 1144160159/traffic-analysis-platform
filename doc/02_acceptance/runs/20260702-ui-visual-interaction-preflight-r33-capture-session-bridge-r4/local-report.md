...
- Run ID: `20260702-ui-visual-interaction-preflight-r33-capture-session-bridge-r4`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r33-capture-session-bridge-r4/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: codex-desktop-node-repl desktop_chrome_list_tabs and js_reset returned Transport closed; Chrome extension backend unavailable, iab fallback forbidden
