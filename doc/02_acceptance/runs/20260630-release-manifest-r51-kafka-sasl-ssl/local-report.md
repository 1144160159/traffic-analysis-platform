...
Run: `20260630-release-manifest-r51-kafka-sasl-ssl`
...
| Repo/live Kafka topic catalog | fail | `kafka-topics-repo.json`, `kafka-topics-live.json` |
...
Summary: `doc/02_acceptance/runs/20260630-release-manifest-r51-kafka-sasl-ssl/live-release-manifest-20260630-release-manifest-r51-kafka-sasl-ssl-summary.json`

Checks: 11/12 passed, 1 failed.
