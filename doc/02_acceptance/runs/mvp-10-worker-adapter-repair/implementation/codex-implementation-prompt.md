...
Use `doc/02_acceptance/runs/mvp-10-worker-adapter-repair/implementation/implementation-brief.md` as the implementation boundary for run `mvp-10-worker-adapter-repair`.
