# Codex Implementation Prompt: CLE-P0-REVIEWER-001

Use `doc/02_acceptance/runs/mvp-36b-workflow-llm-reviewer-docsync/implementation/implementation-brief.md` as the implementation boundary for run `mvp-36b-workflow-llm-reviewer-docsync`.
