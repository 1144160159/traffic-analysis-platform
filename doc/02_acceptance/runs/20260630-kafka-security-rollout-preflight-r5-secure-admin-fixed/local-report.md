...
Run: `20260630-kafka-security-rollout-preflight-r5-secure-admin-fixed`
...
- `doc/02_acceptance/runs/20260630-kafka-security-rollout-preflight-r5-secure-admin-fixed/live-kafka-security-rollout-preflight-20260630-kafka-security-rollout-preflight-r5-secure-admin-fixed-summary.json`
- `doc/02_acceptance/runs/20260630-kafka-security-rollout-preflight-r5-secure-admin-fixed/live-kafka-security-rollout-preflight-20260630-kafka-security-rollout-preflight-r5-secure-admin-fixed.ndjson`
