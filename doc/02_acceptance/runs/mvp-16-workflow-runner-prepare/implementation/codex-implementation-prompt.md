...
Use `doc/02_acceptance/runs/mvp-16-workflow-runner-prepare/implementation/implementation-brief.md` as the implementation boundary for run `mvp-16-workflow-runner-prepare`.
