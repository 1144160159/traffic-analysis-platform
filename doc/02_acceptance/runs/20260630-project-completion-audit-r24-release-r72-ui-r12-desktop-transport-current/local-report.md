...
- Run ID: `20260630-project-completion-audit-r24-release-r72-ui-r12-desktop-transport-current`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r24-release-r72-ui-r12-desktop-transport-current/live-project-completion-audit-20260630-project-completion-audit-r24-release-r72-ui-r12-desktop-transport-current.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r24-release-r72-ui-r12-desktop-transport-current/live-project-completion-audit-20260630-project-completion-audit-r24-release-r72-ui-r12-desktop-transport-current-summary.json`
...
- desktop_browser_smoke: run_id=20260630-ui-contract-preflight-r12-desktop-transport-current browser_checks=2 browser_failed=2 Desktop Chrome wrapper opened login page: transport_closed 2026-06-30 continuation recheck: tool discovery exposed codex-desktop-node-repl wrappers, but desktop_chrome_list_tabs returned Transport closed before Chrome extension backend could list tabs or open the login page; js_reset also returned Transport closed.; Desktop Chrome wrapper opened protected business page: transport_closed 2026-06-30 continuation recheck: Desktop Chrome Bridge MCP transport closed before any protected business page navigation; no Desktop browser page was opened. (`doc/02_acceptance/02-regression/ui-contract-preflight-latest.json`)
