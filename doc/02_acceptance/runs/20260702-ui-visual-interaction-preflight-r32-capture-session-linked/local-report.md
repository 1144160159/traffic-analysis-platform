...
- Run ID: `20260702-ui-visual-interaction-preflight-r32-capture-session-linked`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r32-capture-session-linked/ui-visual-interaction-matrix.json`
