...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r22-runtime-mcp-shape`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r22-runtime-mcp-shape/ui-visual-interaction-matrix.json`
