...
Run: `20260630-kafka-security-rollout-preflight-r4-secure-admin-fallback`
...
- `doc/02_acceptance/runs/20260630-kafka-security-rollout-preflight-r4-secure-admin-fallback/live-kafka-security-rollout-preflight-20260630-kafka-security-rollout-preflight-r4-secure-admin-fallback-summary.json`
- `doc/02_acceptance/runs/20260630-kafka-security-rollout-preflight-r4-secure-admin-fallback/live-kafka-security-rollout-preflight-20260630-kafka-security-rollout-preflight-r4-secure-admin-fallback.ndjson`
