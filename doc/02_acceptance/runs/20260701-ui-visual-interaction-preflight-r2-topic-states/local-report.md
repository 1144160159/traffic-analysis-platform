...
- Run ID: `20260701-ui-visual-interaction-preflight-r2-topic-states`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260701-ui-visual-interaction-preflight-r2-topic-states/ui-visual-interaction-matrix.json`
