...
- run_id: `mvp-25-executor-pool-http-queue`
...
## Children
- `CLE-P0-SCREEN-001` -> `mvp-25-executor-pool-http-queue-cle-p0-screen-001-sandbox-plan` exit `0` status `SANDBOX_WORKER_PLANNED`
