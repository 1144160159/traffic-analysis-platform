...
Use `doc/02_acceptance/runs/mvp-10-worker-cle-p0-screen-001/implementation/implementation-brief.md` as the implementation boundary for run `mvp-10-worker-cle-p0-screen-001`.
