...
## Stage Flow
- `scout.py` skipped: using existing context dir doc/02_acceptance/runs/mvp-10-worker-adapter-repair/context
- `guide.py` skipped: using existing guidance doc/02_acceptance/runs/mvp-10-worker-adapter-repair/guidance/guidance.json
- `design.py` exit `0`
