...
- Run ID: `20260701-project-completion-audit-r32-release-r80-ha-review-r1`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260701-project-completion-audit-r32-release-r80-ha-review-r1/live-project-completion-audit-20260701-project-completion-audit-r32-release-r80-ha-review-r1.ndjson`
- Summary: `doc/02_acceptance/runs/20260701-project-completion-audit-r32-release-r80-ha-review-r1/live-project-completion-audit-20260701-project-completion-audit-r32-release-r80-ha-review-r1-summary.json`
...
- desktop_browser_smoke: run_id=20260701-ui-contract-preflight-r15-desktop-open-url-transport-closed browser_checks=2 browser_failed=2 Desktop Chrome wrapper opened login page: transport_closed 2026-07-01 r15 recheck: codex-desktop-node-repl wrappers were exposed; desktop_chrome_list_tabs returned Transport closed, js_reset returned Transport closed, and required desktop_chrome_open_url(url="http://10.0.5.8:30180/login", keep=true) also returned Transport closed before Chrome extension backend could open the login page.; Desktop Chrome wrapper opened protected business page: transport_closed 2026-07-01 r15 recheck: Desktop Chrome Bridge MCP transport closed before any protected business page navigation; no Desktop browser page was opened and no login submit was attempted. (`doc/02_acceptance/02-regression/ui-contract-preflight-latest.json`)
