...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r20-node-repl-chrome-smoke`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r20-node-repl-chrome-smoke/ui-visual-interaction-matrix.json`
