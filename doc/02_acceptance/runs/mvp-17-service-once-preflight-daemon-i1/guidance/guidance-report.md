...
- generated_from: `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/mvp-17-service-once-preflight-daemon-i1-scout/context`
- blockers: `1`
- warnings: `4`
- recommendations: `12`
...
- `warning` `RUN_EVIDENCE_INCOMPLETE` `mvp-17-service-once-preflight`: Run is missing core files: run-summary.json, task.yaml, plan.md, review-report.md. Suggestion: Do not use this run to close a task until core evidence exists.
- `warning` `RUN_EVIDENCE_INCOMPLETE` `mvp-17-service-once-preflight-daemon`: Run is missing core files: run-summary.json, task.yaml, plan.md, review-report.md. Suggestion: Do not use this run to close a task until core evidence exists.
