...
- Run ID: `20260701-project-completion-audit-r25-release-r73-evidence-refresh`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260701-project-completion-audit-r25-release-r73-evidence-refresh/live-project-completion-audit-20260701-project-completion-audit-r25-release-r73-evidence-refresh.ndjson`
- Summary: `doc/02_acceptance/runs/20260701-project-completion-audit-r25-release-r73-evidence-refresh/live-project-completion-audit-20260701-project-completion-audit-r25-release-r73-evidence-refresh-summary.json`
...
- trial_third_party_signoff: signoff template still contains placeholders or pending signature markers; readiness_run_id=20260701-third-party-signoff-readiness-r13-release-r73-evidence-refresh readiness_result=pass template_tbd_count=159 upstream_blocked_or_nonpass_inputs=5 readiness_release_run_id=20260701-release-manifest-r73-third-party-evidence-refresh current_release_run_id=20260701-release-manifest-r73-third-party-evidence-refresh (`doc/02_acceptance/08-third-party/user-acceptance-signoff.md`)
