...
- generated_from: `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/20260624-loop-prepare-001-scout/context`
- blockers: `0`
- warnings: `10`
- recommendations: `12`
...
- score `1115` `CLE-P0-SCREEN-001` [P0/local/regression]: /screen 只读 token 或脱敏公开边界
- score `1080` `CLE-P0-ROUTE-001` [P0/local/regression]: routeManifest 统一菜单、路由、权限、验收点
- score `1050` `CLE-P0-UIBACKUP-001` [P0/backup/regression]: 备份现有 web/ui 并生成旧前端清单
