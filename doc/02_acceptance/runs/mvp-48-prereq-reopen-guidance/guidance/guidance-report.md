...
- generated_from: `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/mvp-48-prereq-reopen-scout/context`
- blockers: `1`
- warnings: `10`
- recommendations: `12`
...
## Recommended Next
- score `1530` `CLE-P0-ROUTE-001` [P0/local/regression]: routeManifest 统一菜单、路由、权限、验收点
