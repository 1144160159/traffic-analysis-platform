...
|---|---|---|---|
| desktop_browser_smoke | QA / Desktop runtime | runtime_blocked | restore Codex Desktop Chrome bridge transport, capture per-page real React screenshots, generate visual diff and business interaction evidence, then rerun UI contract plus UI visual interaction gates |
