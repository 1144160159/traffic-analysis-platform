...
- run_id: `mvp-9-patch-review-scheduler`
...
## Evidence Signals
- `mvp-3-design-screen` [design_package/acceptance-prep]: status `DESIGN_ITERATING`, missing `0`
...
- `context` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/context/context.snapshot.json`: bounded global snapshot
- `context` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/context/dependency-map.json`: route and contract signals
- `context` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/context/evidence-ledger.json`: prior run evidence state
- `guidance` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/guidance/guidance.json`: blockers and scheduling signal
- `design` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/design-summary.json`: product and architecture strategy
- `design_doc` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/acceptance-cases.md`: acceptance-cases.md
- `design_doc` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/architecture-evolution.md`: architecture-evolution.md
- `design_doc` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/feature-spec.md`: feature-spec.md
- `design_doc` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/implementation-plan.md`: implementation-plan.md
- `design_doc` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/product-iteration.md`: product-iteration.md
- `design_doc` `doc/02_acceptance/runs/mvp-9-patch-review-scheduler/design/visual-correction.md`: visual-correction.md
