...
- Run ID: `20260702-ui-visual-interaction-preflight-r19-login-dom-bottom-veil-region-metrics`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r19-login-dom-bottom-veil-region-metrics/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension wrapper desktop_chrome_list_tabs timed out before and after js_reset in this session; login page remains React DOM/CSS without target-derived underlay. Local Playwright capture r25 added a DOM/CSS bottom veil and kept the corrected capability selector/darker submit button; strict pixel mismatch is 0.9925824652777778, still failing 1:1 threshold 0.015. Region evidence is available in local-dev-dom-r25/login/region-metrics.json.
