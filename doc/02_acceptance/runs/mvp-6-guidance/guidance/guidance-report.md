...
- generated_from: `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/mvp-5-post-workflow-scout/context`
- blockers: `1`
- warnings: `6`
- recommendations: `12`
...
- `warning` `RUN_EVIDENCE_INCOMPLETE` `mvp-5-post-workflow-scout`: Run is missing core files: context/evidence-ledger.json, context/god-view.md. Suggestion: Do not use this run to close a task until core evidence exists.
