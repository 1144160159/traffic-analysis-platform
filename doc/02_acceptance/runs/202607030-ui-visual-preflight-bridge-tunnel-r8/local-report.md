...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r8`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r8/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Windows 10.3.6.59 direct SSH stdio can start node_repl.exe and list js/js_reset/js_add_node_module_dir, but tools/call js exits with Windows sandbox firewall rule creation denied (HRESULT 0x80070005 / 拒绝访问); current Codex session still does not expose Desktop Chrome MCP wrapper tools.
