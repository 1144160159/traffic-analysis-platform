...
- run_id: `mvp-26-executor-pool-isolated-cle-p0-screen-001-sandbox-plan`
...
## Sandbox Plans
- `CLE-P0-SCREEN-001` -> `mvp-26-executor-pool-isolated-cle-p0-screen-001-sandbox-plan-cle-p0-screen-001-sandbox` exit `0` status `SANDBOX_PLAN_READY` workspace `doc/02_acceptance/runs/.loop/worktrees/mvp-26-executor-pool-isolated/cle-p0-screen-001`
