...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r11`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r11/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Windows 10.3.6.59 tunnel is reachable from both Linux and Windows localhost endpoints, and the trusted-context Desktop Chrome payload now parses and passes 21/21 self-test checks with all capture URL templates bound to 127.0.0.1:25173/25174/25175. Current Codex session still does not expose mcp__codex_desktop_node_repl__js or desktop_chrome_* tools, and SSH-spawned node_repl.exe JS still fails before Chrome control with Windows sandbox firewall rule creation denied (SetRemotePorts HRESULT 0x80070005 / 拒绝访问).
