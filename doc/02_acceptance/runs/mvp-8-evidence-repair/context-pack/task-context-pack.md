...
## Evidence Signals
- `mvp-1-god-view` [context_scout/regression]: status `CONTEXT_SCOUTED`, missing `0`
...
- `context` `doc/02_acceptance/runs/mvp-8-evidence-repair/context/context.snapshot.json`: bounded global snapshot
- `context` `doc/02_acceptance/runs/mvp-8-evidence-repair/context/dependency-map.json`: route and contract signals
- `context` `doc/02_acceptance/runs/mvp-8-evidence-repair/context/evidence-ledger.json`: prior run evidence state
- `guidance` `doc/02_acceptance/runs/mvp-8-evidence-repair/guidance/guidance.json`: blockers and scheduling signal
- `design` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/design-summary.json`: product and architecture strategy
- `design_doc` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/acceptance-cases.md`: acceptance-cases.md
- `design_doc` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/architecture-evolution.md`: architecture-evolution.md
- `design_doc` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/feature-spec.md`: feature-spec.md
- `design_doc` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/implementation-plan.md`: implementation-plan.md
- `design_doc` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/product-iteration.md`: product-iteration.md
- `design_doc` `doc/02_acceptance/runs/mvp-8-evidence-repair/design/visual-correction.md`: visual-correction.md
