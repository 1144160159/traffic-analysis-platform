...
## Inputs
- context_pack: `doc/02_acceptance/runs/mvp-12-persistent-queue-metrics-i1-worker-cle-p0-screen-001/context-pack/task-context-pack.md`
- design_dir: `doc/02_acceptance/runs/mvp-12-persistent-queue-metrics-i1-worker-cle-p0-screen-001/design`
- plan: `doc/02_acceptance/runs/mvp-12-persistent-queue-metrics-i1-worker-cle-p0-screen-001/plan.md`
