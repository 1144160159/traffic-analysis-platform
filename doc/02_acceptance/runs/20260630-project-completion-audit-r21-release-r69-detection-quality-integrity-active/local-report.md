...
- Run ID: `20260630-project-completion-audit-r21-release-r69-detection-quality-integrity-active`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r21-release-r69-detection-quality-integrity-active/live-project-completion-audit-20260630-project-completion-audit-r21-release-r69-detection-quality-integrity-active.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r21-release-r69-detection-quality-integrity-active/live-project-completion-audit-20260630-project-completion-audit-r21-release-r69-detection-quality-integrity-active-summary.json`
...
- trial_third_party_signoff: signoff template still contains placeholders or pending signature markers; readiness_run_id=20260630-third-party-signoff-readiness-r9-release-r69-detection-quality-integrity-active readiness_result=pass template_tbd_count=159 upstream_blocked_or_nonpass_inputs=5 readiness_release_run_id=20260630-release-manifest-r69-detection-quality-integrity-active current_release_run_id=20260630-release-manifest-r69-detection-quality-integrity-active (`doc/02_acceptance/08-third-party/user-acceptance-signoff.md`)
