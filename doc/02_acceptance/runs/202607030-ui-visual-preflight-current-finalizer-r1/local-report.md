...
- Run ID: `202607030-ui-visual-preflight-current-finalizer-r1`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-current-finalizer-r1/ui-visual-interaction-matrix.json`
