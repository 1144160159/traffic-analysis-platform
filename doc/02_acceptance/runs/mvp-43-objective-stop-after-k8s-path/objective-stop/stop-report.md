...
- run_id: `mvp-43-objective-stop-after-k8s-path`
...
- `blocker` `RELEASE_EVIDENCE_MISSING` `doc/02_acceptance/runs/mvp-43-release-blocked-by-readiness/release/release-manifest.json`: Release evidence is missing: doc/02_acceptance/runs/mvp-43-release-blocked-by-readiness/release/release-manifest.json. Recommendation: Regenerate release evidence before objective stop.
