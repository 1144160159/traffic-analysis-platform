...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r13`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Capture session: `blocked_desktop_transport_closed` covers_current_gaps=true
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r13/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Windows 10.3.6.59 tunnel is reachable from Linux and Windows localhost endpoints; Windows SSH privilege preflight passes 9/9 with Administrators group enabled, high-integrity token, firewall service running, and Codex/Chrome/node_repl processes visible; trusted-context Desktop Chrome payload parses/passes 21/21 with 127.0.0.1:25173/25174/25175 URLs; outer MCP tool-call template for mcp__codex_desktop_node_repl__js passes 9/9 and binds the exact payload SHA 3f0f6d0128d0e4b8807e7addd52d9371a06f070cedceb2116f3a1148743a9e4a. Current Codex session still lacks mcp__codex_desktop_node_repl__js or desktop_chrome_*; SSH-spawned node_repl.exe JS still fails before Chrome control with Windows sandbox/native-pipe boundary despite elevated SSH token.
