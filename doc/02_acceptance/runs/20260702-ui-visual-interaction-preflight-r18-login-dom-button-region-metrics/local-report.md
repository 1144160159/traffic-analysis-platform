...
- Run ID: `20260702-ui-visual-interaction-preflight-r18-login-dom-button-region-metrics`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r18-login-dom-button-region-metrics/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension wrapper desktop_chrome_list_tabs timed out before and after js_reset in this session; login page remains React DOM/CSS without target-derived underlay. Local Playwright capture r22 fixed the capability icon selector bug and darker login button; strict pixel mismatch is 0.9934886188271604, still failing 1:1 threshold 0.015. Region evidence is available in local-dev-dom-r22/login/region-metrics.json.
