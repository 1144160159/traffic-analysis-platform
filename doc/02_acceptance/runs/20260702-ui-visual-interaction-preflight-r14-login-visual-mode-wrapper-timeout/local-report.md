...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r14-login-visual-mode-wrapper-timeout/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension wrapper desktop_chrome_list_tabs timed out before and after js_reset; login visual target now uses /login?__taf_visual=1 to freeze captcha for visual diff, but formal 1920x1080 Desktop Chrome capture remains blocked.
