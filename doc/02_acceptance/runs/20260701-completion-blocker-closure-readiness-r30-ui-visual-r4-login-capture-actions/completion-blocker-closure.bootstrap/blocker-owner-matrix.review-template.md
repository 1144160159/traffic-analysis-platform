...
|---|---|---|---|
| desktop_browser_smoke | QA / Desktop runtime | authenticated_business_page_blocked | establish a reproducible authenticated Desktop Chrome business-page flow, normalize Desktop capture to 1920x1080, then rerun UI contract and capture real React screenshots plus remaining business interactions |
| ui_visual_interaction | Frontend / QA | visual_diff_blocked_and_interaction_partial | fix Desktop Chrome capture viewport to 1920x1080, regenerate 30 real React page screenshot diffs, record the remaining 27 route-specific interaction.json files, then rerun the UI visual interaction gate |
