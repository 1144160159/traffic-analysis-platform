...
- `context` `doc/02_acceptance/runs/mvp-1-god-view/context/context.snapshot.json`: bounded global snapshot
- `context` `doc/02_acceptance/runs/mvp-1-god-view/context/dependency-map.json`: route and contract signals
- `context` `doc/02_acceptance/runs/mvp-1-god-view/context/evidence-ledger.json`: prior run evidence state
- `guidance` `doc/02_acceptance/runs/mvp-2-guidance/guidance/guidance.json`: blockers and scheduling signal
- `design` `doc/02_acceptance/runs/mvp-3-design-screen/design/design-summary.json`: product and architecture strategy
- `design_doc` `doc/02_acceptance/runs/mvp-3-design-screen/design/acceptance-cases.md`: acceptance-cases.md
- `design_doc` `doc/02_acceptance/runs/mvp-3-design-screen/design/architecture-evolution.md`: architecture-evolution.md
- `design_doc` `doc/02_acceptance/runs/mvp-3-design-screen/design/feature-spec.md`: feature-spec.md
- `design_doc` `doc/02_acceptance/runs/mvp-3-design-screen/design/implementation-plan.md`: implementation-plan.md
- `design_doc` `doc/02_acceptance/runs/mvp-3-design-screen/design/product-iteration.md`: product-iteration.md
- `design_doc` `doc/02_acceptance/runs/mvp-3-design-screen/design/visual-correction.md`: visual-correction.md
