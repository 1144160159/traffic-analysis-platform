...
- generated_from: `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/mvp-47-screen-fix-scout/context`
- blockers: `0`
- warnings: `10`
- recommendations: `12`
...
- score `1365` `CLE-P0-SCREEN-001` [P0/local/regression]: /screen 只读 token 或脱敏公开边界
