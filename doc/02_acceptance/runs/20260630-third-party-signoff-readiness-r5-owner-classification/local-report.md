...
- Run ID: `20260630-third-party-signoff-readiness-r5-owner-classification`
- Result: `pass`
- Template TBD count: 159
- Upstream non-pass or blocked evidence inputs: 5
- Bootstrap dir: `doc/02_acceptance/runs/20260630-third-party-signoff-readiness-r5-owner-classification/signoff-readiness.bootstrap`
- Stable bootstrap dir: `doc/02_acceptance/08-third-party/readiness/latest`
- Summary: `doc/02_acceptance/runs/20260630-third-party-signoff-readiness-r5-owner-classification/third-party-signoff-readiness-20260630-third-party-signoff-readiness-r5-owner-classification-summary.json`
