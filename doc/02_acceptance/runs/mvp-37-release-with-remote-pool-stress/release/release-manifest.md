...
- run_id: `mvp-37-release-with-remote-pool-stress`
...
- remote_pool_stress: `doc/02_acceptance/runs/mvp-37-remote-pool-stress-release/remote-pool-stress/stress-summary.json`
- remote_pool_stress_status: `REMOTE_POOL_STRESS_COMPLETED`
- remote_pool_stress_workers: `4`
