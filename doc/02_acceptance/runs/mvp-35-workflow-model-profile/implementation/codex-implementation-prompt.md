...
Use `doc/02_acceptance/runs/mvp-35-workflow-model-profile/implementation/implementation-brief.md` as the implementation boundary for run `mvp-35-workflow-model-profile`.
