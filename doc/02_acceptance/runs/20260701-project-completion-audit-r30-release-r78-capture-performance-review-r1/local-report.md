...
- Run ID: `20260701-project-completion-audit-r30-release-r78-capture-performance-review-r1`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260701-project-completion-audit-r30-release-r78-capture-performance-review-r1/live-project-completion-audit-20260701-project-completion-audit-r30-release-r78-capture-performance-review-r1.ndjson`
- Summary: `doc/02_acceptance/runs/20260701-project-completion-audit-r30-release-r78-capture-performance-review-r1/live-project-completion-audit-20260701-project-completion-audit-r30-release-r78-capture-performance-review-r1-summary.json`
...
- desktop_browser_smoke: run_id=20260701-ui-contract-preflight-r14-desktop-transport-current browser_checks=2 browser_failed=2 Desktop Chrome wrapper opened login page: transport_closed 2026-07-01 r14 recheck: codex-desktop-node-repl wrappers were exposed, but desktop_chrome_list_tabs returned Transport closed before Chrome extension backend could list tabs or open the login page; js_reset also returned Transport closed. desktop_chrome_open_url was not called in this recheck.; Desktop Chrome wrapper opened protected business page: transport_closed 2026-07-01 r14 recheck: Desktop Chrome Bridge MCP transport closed before any protected business page navigation; no Desktop browser page was opened and no desktop_chrome_open_url call was attempted. (`doc/02_acceptance/02-regression/ui-contract-preflight-latest.json`)
...
- trial_third_party_signoff: signoff template still contains placeholders or pending signature markers; readiness_run_id=20260701-third-party-signoff-readiness-r18-release-r78-capture-performance-review-r1 readiness_result=pass template_tbd_count=159 upstream_blocked_or_nonpass_inputs=5 readiness_release_run_id=20260701-release-manifest-r78-capture-performance-review-r1 current_release_run_id=20260701-release-manifest-r78-capture-performance-review-r1 (`doc/02_acceptance/08-third-party/user-acceptance-signoff.md`)
