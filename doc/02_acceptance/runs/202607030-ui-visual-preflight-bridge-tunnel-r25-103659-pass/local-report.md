...
- Desktop smoke token config: repo=true live=false
- Desktop Chrome status: `missing`
- Capture session: `desktop_bridge_blocked` covers_current_gaps=true
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r25-103659-pass/ui-visual-interaction-matrix.json`
...
## Blockers
- `config` Desktop smoke token is enabled in live runtime config: spawnSync curl EPERM
