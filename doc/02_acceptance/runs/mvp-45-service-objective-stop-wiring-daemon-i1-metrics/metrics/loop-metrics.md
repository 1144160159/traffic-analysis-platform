...
- generated_at: `2026-06-24T09:59:14`
- run_total: `356`
- queue_total: `1`
- queue_counts: `{'done': 1}`
...
- `LOCK_ACQUIRED`: `13`
- `METRICS_COLLECTED`: `14`
- `OBJECTIVE_STOP_BLOCKED`: `9`
...
- `mvp-44-remote-pool-k8s-readiness-after-apply` `remote_pool_k8s_readiness` `REMOTE_POOL_K8S_READINESS_DEGRADED`
- `mvp-44-k8s-bootstrap-queue-service-apply-toleration` `k8s_bootstrap` `K8S_BOOTSTRAP_APPLIED`
- `mvp-44-queue-service-k8s-deploy-plan-pv-toleration` `deploy_plan` `DEPLOY_PLAN_READY`
- `mvp-44-remote-pool-k8s-plan-pv-toleration` `remote_pool_k8s_stress` `REMOTE_POOL_K8S_STRESS_VALIDATED`
- `mvp-44-k8s-bootstrap-queue-service-apply` `k8s_bootstrap` `K8S_BOOTSTRAP_BLOCKED`
- `mvp-44-k8s-bootstrap-queue-service-plan-pv` `k8s_bootstrap` `K8S_BOOTSTRAP_VALIDATED`
- `mvp-44-queue-service-k8s-deploy-plan-pv` `deploy_plan` `DEPLOY_PLAN_READY`
- `mvp-44-remote-pool-k8s-plan-pv` `remote_pool_k8s_stress` `REMOTE_POOL_K8S_STRESS_VALIDATED`
