...
- Run ID: `20260630-project-completion-audit-r12-signoff-prefill`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r12-signoff-prefill/live-project-completion-audit-20260630-project-completion-audit-r12-signoff-prefill.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r12-signoff-prefill/live-project-completion-audit-20260630-project-completion-audit-r12-signoff-prefill-summary.json`
...
- trial_third_party_signoff: signoff template still contains placeholders or pending signature markers; readiness_run_id=20260630-third-party-signoff-readiness-r3-prefilled-deployment-proof readiness_result=pass template_tbd_count=166 upstream_blocked_or_nonpass_inputs=5 (`doc/02_acceptance/08-third-party/user-acceptance-signoff.md`)
