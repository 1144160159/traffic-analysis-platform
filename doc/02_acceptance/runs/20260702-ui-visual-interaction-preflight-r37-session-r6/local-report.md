...
- Run ID: `20260702-ui-visual-interaction-preflight-r37-session-r6`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r37-session-r6/ui-visual-interaction-matrix.json`
