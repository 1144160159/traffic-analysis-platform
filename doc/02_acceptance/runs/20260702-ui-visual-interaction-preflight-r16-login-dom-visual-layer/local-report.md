...
- Run ID: `20260702-ui-visual-interaction-preflight-r16-login-dom-visual-layer`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r16-login-dom-visual-layer/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension wrapper remains unavailable in this session; login page remains React DOM/CSS without target-derived underlay. Local Playwright capture r18 improved strict pixel mismatch from 0.9978853202160494 to 0.9935165895061728, still failing 1:1 threshold 0.015.
