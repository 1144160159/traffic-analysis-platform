...
- Run ID: `20260630-project-completion-audit-r8-desktop-bridge-current`
- Result: `blocked`
- Passed gates: 7
- Failed gates: 8
- Blockers: 8
- Warnings: 0
- NDJSON: `doc/02_acceptance/runs/20260630-project-completion-audit-r8-desktop-bridge-current/live-project-completion-audit-20260630-project-completion-audit-r8-desktop-bridge-current.ndjson`
- Summary: `doc/02_acceptance/runs/20260630-project-completion-audit-r8-desktop-bridge-current/live-project-completion-audit-20260630-project-completion-audit-r8-desktop-bridge-current-summary.json`
...
- desktop_browser_smoke: run_id=20260630-ui-contract-preflight-r10-desktop-bridge-current browser_checks=2 browser_failed=2 Desktop Chrome wrapper opened login page: transport_closed 2026-06-30 current recheck: desktop_iab_list_targets, desktop_chrome_list_tabs, js_reset, and desktop_chrome_open_url(http://10.0.5.8:30180/login) all returned Transport closed after wrapper namespace was exposed by tool discovery; Desktop Chrome wrapper opened protected business page: transport_closed 2026-06-30 current recheck: Codex Desktop Chrome Bridge MCP transport closed before any protected business page navigation; no Desktop browser page was opened (`doc/02_acceptance/02-regression/ui-contract-preflight-latest.json`)
