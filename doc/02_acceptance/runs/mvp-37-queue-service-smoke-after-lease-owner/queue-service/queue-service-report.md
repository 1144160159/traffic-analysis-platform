...
- run_id: `mvp-37-queue-service-smoke-after-lease-owner`
- status: `QUEUE_SERVICE_SMOKE_PASSED`
- backend: `sqlite`
- queue_path: `doc/02_acceptance/runs/mvp-37-queue-service-smoke-after-lease-owner/queue-service/queue-service-smoke.sqlite3`
- host: `127.0.0.1`
- port: `40679`
