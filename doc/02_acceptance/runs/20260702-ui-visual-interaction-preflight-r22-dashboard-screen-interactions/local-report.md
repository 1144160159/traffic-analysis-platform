...
- Run ID: `20260702-ui-visual-interaction-preflight-r22-dashboard-screen-interactions`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r22-dashboard-screen-interactions/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Desktop Chrome extension backend captured dashboard and screen interaction evidence after enabling DESKTOP_SMOKE_TOKEN_ENABLED=true, but subsequent Desktop Chrome tab control/list operations timed out before more route captures. Visual gate still requires reliable browser-generated 1920x1080 screenshots.
