...
- Run ID: `20260702-ui-visual-interaction-preflight-r25-desktop-transport-closed`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r25-desktop-transport-closed/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: codex-desktop-node-repl MCP transport closed for both desktop_chrome_list_tabs and minimal js probe; Chrome extension backend cannot be used for new screenshots/interactions in this session.
