...
- run_id: `mvp-40-remote-pool-k8s-readiness`
...
- worker_job: `doc/02_acceptance/runs/mvp-39-remote-pool-k8s-plan/remote-pool-k8s-stress/remote-pool-worker-job.yaml`
