...
- Run ID: `20260702-ui-visual-interaction-preflight-r13-login-low-exposure-source`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r13-login-low-exposure-source/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Chrome extension target remains visible, but tab-control path timed out after the CDP viewport probe; local source build removed default login credentials and login-exception trigger from the rendered login body, but formal Desktop Chrome 1920x1080 visual capture is still blocked.
