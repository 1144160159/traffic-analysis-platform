...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r6`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r6/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Windows 10.3.6.59 SSH tunnel reached the host, but current Codex session still lacks Desktop Chrome MCP tools; forwarded 19998 closed without MCP response and Windows 19998 listener was not observed.
