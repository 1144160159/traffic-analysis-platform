...
- run_id: `mvp-44-remote-pool-k8s-readiness-after-apply`
- status: `REMOTE_POOL_K8S_READINESS_DEGRADED`
...
- worker_job: `doc/02_acceptance/runs/mvp-44-remote-pool-k8s-plan-pv-toleration/remote-pool-k8s-stress/remote-pool-worker-job.yaml`
