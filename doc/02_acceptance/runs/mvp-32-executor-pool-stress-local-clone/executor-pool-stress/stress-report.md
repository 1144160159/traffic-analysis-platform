...
- run_id: `mvp-32-executor-pool-stress-local-clone`
...
## Iterations
- `mvp-32-executor-pool-stress-local-clone-i001` pool `EXECUTOR_POOL_PLANNED` cleanup `WORKSPACE_CLEANUP_COMPLETED` leaks `0`
- `mvp-32-executor-pool-stress-local-clone-i002` pool `EXECUTOR_POOL_PLANNED` cleanup `WORKSPACE_CLEANUP_COMPLETED` leaks `0`
