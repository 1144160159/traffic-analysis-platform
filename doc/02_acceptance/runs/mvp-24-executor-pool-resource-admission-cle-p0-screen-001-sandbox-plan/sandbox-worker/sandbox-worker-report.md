...
- run_id: `mvp-24-executor-pool-resource-admission-cle-p0-screen-001-sandbox-plan`
...
## Sandbox Plans
- `CLE-P0-SCREEN-001` -> `mvp-24-executor-pool-resource-admission-cle-p0-screen-001-sandbox-plan-cle-p0-screen-001-sandbox` exit `0` status `SANDBOX_PLAN_READY`
