...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r16-windows`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/202607030-ui-visual-preflight-bridge-tunnel-r16-windows/ui-visual-interaction-matrix.json`
