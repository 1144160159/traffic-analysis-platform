# Codex Implementation Prompt: CLE-P0-SCREEN-001

Use `doc/02_acceptance/runs/mvp-15-sqlite-service-once-daemon-i1-worker-cle-p0-screen-001/implementation/implementation-brief.md` as the implementation boundary for run `mvp-15-sqlite-service-once-daemon-i1-worker-cle-p0-screen-001`.
