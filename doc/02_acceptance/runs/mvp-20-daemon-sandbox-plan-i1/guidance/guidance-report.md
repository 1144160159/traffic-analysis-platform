...
- generated_from: `/home/wangwt/phase_2/code/traffic-analysis-platform/doc/02_acceptance/runs/mvp-20-daemon-sandbox-plan-i1-scout/context`
- blockers: `1`
- warnings: `3`
- recommendations: `12`
...
- `warning` `RUN_EVIDENCE_INCOMPLETE` `mvp-20-daemon-sandbox-plan`: Run is missing core files: run-summary.json, task.yaml, plan.md, review-report.md. Suggestion: Do not use this run to close a task until core evidence exists.
