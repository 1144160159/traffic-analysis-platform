...
- Run ID: `20260702-ui-visual-interaction-preflight-r9-appshell-realtime-bottom`
- Result: `blocked`
- Target routes: 28
- Visual targets: 30
...
- Matrix: `doc/02_acceptance/runs/20260702-ui-visual-interaction-preflight-r9-appshell-realtime-bottom/ui-visual-interaction-matrix.json`
...
- `desktop-chrome` Codex Desktop Chrome wrapper is available for screenshot and interaction capture: Chrome extension target is available, but 1920x1080 Desktop Chrome screenshot capture remains blocked in this session; AppShell realtime status was moved out of the fixed topbar and verified by local Playwright auth-gate.
