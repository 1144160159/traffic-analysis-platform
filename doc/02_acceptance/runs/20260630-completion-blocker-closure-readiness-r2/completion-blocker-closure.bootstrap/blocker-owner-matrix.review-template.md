...
|---|---|---|---|
| desktop_browser_smoke | QA / Desktop runtime | runtime_blocked | restore Codex Desktop Chrome bridge transport and rerun UI contract preflight with Desktop Chrome login and protected business-page smoke |
