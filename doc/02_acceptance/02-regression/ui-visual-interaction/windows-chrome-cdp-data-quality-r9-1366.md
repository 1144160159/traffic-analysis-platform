...
- Run ID: `windows-cdp-full-route-20260703111225`
- Result: `pass`
...
- Viewport: `1366x768`
- Evidence dir: `evidence/windows-chrome-cdp-20260703-data-quality-r9-1366`
- Acceptance dir: `doc/02_acceptance/02-regression/ui-visual-interaction/windows-cdp-data-quality-r9-1366`
...
|---|---:|---:|---:|---|---|
| `data-quality` | pass | skipped | - | `evidence/windows-chrome-cdp-20260703-data-quality-r9-1366/data-quality-1366x768.png` | `http://10.0.5.8:30180/data-quality?windowsCdpEvidenceTs=1783077145552` |
