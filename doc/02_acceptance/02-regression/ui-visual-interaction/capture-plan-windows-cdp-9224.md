...
```bash
DESKTOP_SMOKE_TOKEN=<redacted> CODEX_SMOKE_NONCE=<redacted> tests/e2e/ui_desktop_smoke_redirect.py --host 0.0.0.0 --port 15175 --app-base-url http://10.0.5.8:30180 --default-route /dashboard --max-redirects 53
```
...
- Run ID: `202607030-ui-visual-preflight-bridge-tunnel-r25-103659-pass`
- Visual gaps: `30/30`
...
```bash
DESKTOP_SMOKE_TOKEN=<redacted> CODEX_CAPTURE_KEY=<redacted> tests/e2e/ui_desktop_capture_receiver.py --host 0.0.0.0 --port 15174 --evidence-dir doc/02_acceptance/02-regression/ui-visual-interaction/latest --max-uploads 55 --expected-width 1920 --expected-height 1080
```
...
|---|---|---|---|
| `login` | `login` | `http://10.0.5.8:30180/login` | metrics status=fail; pixel mismatch ratio 0.9999099151449858 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta status=blocked; uploaded screenshot 2559x1271 != 1920x1080; stored screenshot 2559x1271 != 1920x1080; Desktop Chrome viewport 2560x1271 != 1920x1080 |
| `screen` | `screen` | `http://10.0.5.8:30180/screen#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | metrics status=fail; pixel mismatch ratio 0.9999508069051117 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta status=blocked; uploaded screenshot 2559x1271 != 1920x1080; stored screenshot 2559x1271 != 1920x1080; Desktop Chrome viewport 2560x1271 != 1920x1080 |
| `dashboard` | `dashboard` | `http://10.0.5.8:30180/dashboard#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | metrics status=fail; pixel mismatch ratio 0.9999188313934344 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta status=blocked; uploaded screenshot 2559x1271 != 1920x1080; stored screenshot 2559x1271 != 1920x1080; Desktop Chrome viewport 2560x1271 != 1920x1080 |
| `alerts` | `alerts` | `http://10.0.5.8:30180/alerts#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | metrics status=fail; pixel mismatch ratio 0.9999425055703494 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta status=blocked; uploaded screenshot 2559x1271 != 1920x1080; stored screenshot 2559x1271 != 1920x1080; Desktop Chrome viewport 2560x1271 != 1920x1080 |
| `alert-detail` | `alert-detail` | `http://10.0.5.8:30180/alerts/AL-20260620-000123#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `campaigns` | `campaigns` | `http://10.0.5.8:30180/campaigns#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `campaign-detail` | `campaign-detail` | `http://10.0.5.8:30180/campaigns/APT-20260619-001#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `attack-chains` | `attack-chains` | `http://10.0.5.8:30180/attack-chains#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `encrypted-traffic` | `encrypted-traffic` | `http://10.0.5.8:30180/encrypted-traffic#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `forensics` | `forensics` | `http://10.0.5.8:30180/forensics#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `assets` | `assets` | `http://10.0.5.8:30180/assets#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `graph` | `graph` | `http://10.0.5.8:30180/graph#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `fusion` | `fusion` | `http://10.0.5.8:30180/fusion#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `baselines` | `baselines` | `http://10.0.5.8:30180/baselines#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `probes` | `probes` | `http://10.0.5.8:30180/probes#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `rules` | `rules` | `http://10.0.5.8:30180/rules#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `deployments` | `deployments` | `http://10.0.5.8:30180/deployments#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `models` | `models` | `http://10.0.5.8:30180/models#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `mlops` | `mlops` | `http://10.0.5.8:30180/mlops#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `data-quality` | `data-quality` | `http://10.0.5.8:30180/data-quality#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `playbooks` | `playbooks` | `http://10.0.5.8:30180/playbooks#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `whitelist` | `whitelist` | `http://10.0.5.8:30180/whitelist#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `compliance` | `compliance` | `http://10.0.5.8:30180/compliance#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `audit-log` | `audit-log` | `http://10.0.5.8:30180/audit-log#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `notifications` | `notifications` | `http://10.0.5.8:30180/notifications#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `settings` | `settings` | `http://10.0.5.8:30180/settings#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |
| `not-found` | `not-found` | `http://10.0.5.8:30180/__codex_visual_not_found__#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing actual-1920.png; missing diff-1920.png; missing metrics.json; missing capture-meta.json |

## Next Interaction Routes

| route | URL | template | auth mode | required business action | missing or failing |
|---|---|---|---|---|---|
| `alert-detail` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Falerts%2FAL-20260620-000123` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/alert-detail/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 告警详情: verify live data from /api/v1/alerts/{id}, /api/v1/alerts/{id}/evidence, /api/v1/alerts/{id}/feedback; perform one route-specific read or safe UI action | missing interaction.json |
...
| `campaign-detail` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fcampaigns%2FAPT-20260619-001` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/campaign-detail/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 战役详情: verify live data from /api/v1/campaigns/{id}; perform one route-specific read or safe UI action | missing interaction.json |
