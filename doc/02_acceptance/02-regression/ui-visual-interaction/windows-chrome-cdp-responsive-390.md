...
- Run ID: `windows-cdp-full-route-20260703104721`
- Result: `pass`
...
- Viewport: `390x844`
- Evidence dir: `evidence/windows-chrome-cdp-20260703-responsive-390-r1`
- Acceptance dir: `doc/02_acceptance/02-regression/ui-visual-interaction/windows-cdp-responsive-390`
...
|---|---:|---:|---:|---|---|
| `dashboard` | pass | skipped | - | `evidence/windows-chrome-cdp-20260703-responsive-390-r1/dashboard-390x844.png` | `http://10.0.5.8:30180/dashboard?windowsCdpEvidenceTs=1783075641186` |
| `data-quality` | pass | skipped | - | `evidence/windows-chrome-cdp-20260703-responsive-390-r1/data-quality-390x844.png` | `http://10.0.5.8:30180/data-quality?windowsCdpEvidenceTs=1783075641186` |
