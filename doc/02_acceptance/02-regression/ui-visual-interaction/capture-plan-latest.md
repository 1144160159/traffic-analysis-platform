...
- Generated: `2026-07-11T04:59:44.689Z`
- Base URL: `http://10.0.5.8:30180`
- Receiver URL: `http://10.0.5.8:15174`
- Viewport probe URL: `http://10.0.5.8:15174/viewport-probe`
- Visual evidence: `0/28`
...
```text
http://10.0.5.8:30180/dashboard#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>
```
...
```bash
DESKTOP_SMOKE_TOKEN=<redacted> CODEX_SMOKE_NONCE=<redacted> tests/e2e/ui_desktop_smoke_redirect.py --host 0.0.0.0 --port 15175 --app-base-url http://10.0.5.8:30180 --default-route /dashboard --max-redirects 54
```
...
```bash
DESKTOP_SMOKE_TOKEN=<redacted> CODEX_CAPTURE_KEY=<redacted> tests/e2e/ui_desktop_capture_receiver.py --host 0.0.0.0 --port 15174 --evidence-dir doc/02_acceptance/02-regression/ui-visual-interaction/latest --max-uploads 56 --expected-width 1920 --expected-height 1080
```
...
|---|---|---|---|
| `login` | `login` | `http://10.0.5.8:30180/login` | metrics status=fail; pixel mismatch ratio 0.9999099151449858 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta backend=windows-chrome-cdp |
| `screen` | `screen` | `http://10.0.5.8:30180/screen#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | metrics status=fail; pixel mismatch ratio 0.9999508069051117 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta backend=windows-chrome-cdp |
| `dashboard` | `dashboard` | `http://10.0.5.8:30180/dashboard#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | metrics status=fail; pixel mismatch ratio 0.9999188313934344 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta backend=windows-chrome-cdp |
| `alerts` | `alerts` | `http://10.0.5.8:30180/alerts#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | metrics status=fail; pixel mismatch ratio 0.9999425055703494 > 0.015; viewport 2559x1271 != 1920x1080; capture-meta backend=windows-chrome-cdp |
| `alert-detail` | `alert-detail` | `http://10.0.5.8:30180/alerts/alert-default-1782752318016-1dd589c4#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta status=fail; capture-meta backend=windows-chrome-cdp |
| `campaigns` | `campaigns` | `http://10.0.5.8:30180/campaigns#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `campaign-detail` | `campaign-detail` | `http://10.0.5.8:30180/campaigns/campaign-exfil-default-1782729598739-e1d2dc37#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta status=fail; capture-meta backend=windows-chrome-cdp |
| `attack-chains` | `attack-chains` | `http://10.0.5.8:30180/attack-chains#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `encrypted-traffic` | `encrypted-traffic` | `http://10.0.5.8:30180/encrypted-traffic#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `forensics` | `forensics` | `http://10.0.5.8:30180/forensics#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `assets` | `assets` | `http://10.0.5.8:30180/assets#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `graph` | `graph` | `http://10.0.5.8:30180/graph#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `fusion` | `fusion` | `http://10.0.5.8:30180/fusion#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `baselines` | `baselines` | `http://10.0.5.8:30180/baselines#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta status=fail; capture-meta backend=windows-chrome-cdp |
| `probes` | `probes` | `http://10.0.5.8:30180/probes#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `rules` | `rules` | `http://10.0.5.8:30180/rules#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `deployments` | `deployments` | `http://10.0.5.8:30180/deployments#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `models` | `models` | `http://10.0.5.8:30180/models#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `mlops` | `mlops` | `http://10.0.5.8:30180/mlops#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `data-quality` | `data-quality` | `http://10.0.5.8:30180/data-quality#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `playbooks` | `playbooks` | `http://10.0.5.8:30180/playbooks#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `whitelist` | `whitelist` | `http://10.0.5.8:30180/whitelist#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta status=fail; capture-meta backend=windows-chrome-cdp |
| `compliance` | `compliance` | `http://10.0.5.8:30180/compliance#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `audit-log` | `audit-log` | `http://10.0.5.8:30180/audit-log#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `notifications` | `notifications` | `http://10.0.5.8:30180/notifications#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `settings` | `settings` | `http://10.0.5.8:30180/settings#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `not-found` | `not-found` | `http://10.0.5.8:30180/__codex_visual_not_found__#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |
| `topics` | `topics` | `http://10.0.5.8:30180/topics#codex_smoke_token=<DESKTOP_SMOKE_TOKEN>` | missing diff-1920.png; missing metrics.json; capture-meta backend=windows-chrome-cdp |

## Next Interaction Routes

| route | URL | template | auth mode | required business action | missing or failing |
|---|---|---|---|---|---|
| `alert-detail` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Falerts%2Falert-default-1782752318016-1dd589c4` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/alert-detail/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 告警详情: verify live data from /api/v1/alerts/{id}, /api/v1/alerts/{id}/evidence, /api/v1/alerts/{id}/feedback; perform one route-specific read or safe UI action | missing interaction.json |
| `campaigns` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fcampaigns` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/campaigns/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 战役列表: verify live data from /api/v1/campaigns; perform one route-specific read or safe UI action | missing interaction.json |
| `campaign-detail` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fcampaigns%2Fcampaign-exfil-default-1782729598739-e1d2dc37` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/campaign-detail/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 战役详情: verify live data from /api/v1/campaigns/{id}; perform one route-specific read or safe UI action | missing interaction.json |
| `attack-chains` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fattack-chains` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/attack-chains/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 攻击链分析: verify live data from /api/v1/attack-chains; perform one route-specific read or safe UI action | missing interaction.json |
| `encrypted-traffic` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fencrypted-traffic` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/encrypted-traffic/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 加密流量: verify live data from /api/v1/encrypted-traffic/stats, /api/v1/encrypted-traffic/sessions, /api/v1/encrypted-traffic/ja3, /api/v1/encrypted-traffic/tunnels, /api/v1/encrypted-traffic/exfiltration; perform one route-specific read or safe UI action | missing interaction.json |
| `forensics` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fforensics` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/forensics/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 取证分析: verify live data from /api/v1/pcap/jobs, /api/v1/pcap/stats; perform one route-specific read or safe UI action | missing interaction.json |
| `assets` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fassets` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/assets/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 资产台账: verify live data from /api/v1/assets; perform one route-specific read or safe UI action | missing interaction.json |
| `graph` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fgraph` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/graph/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 实体图谱: verify live data from /api/v1/graph/explore; perform one route-specific read or safe UI action | missing interaction.json |
| `fusion` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Ffusion` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/fusion/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 数据融合: verify live data from /api/v1/fusion/stats, /api/v1/fusion/entities; perform one route-specific read or safe UI action | missing interaction.json |
| `baselines` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fbaselines` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/baselines/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 行为基准: verify live data from /api/v1/baselines; perform one route-specific read or safe UI action | missing interaction.json |
| `probes` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fprobes` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/probes/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 探针管理: verify live data from /api/v1/probes; perform one route-specific read or safe UI action | missing interaction.json |
| `rules` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Frules` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/rules/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 规则管理: verify live data from /api/v1/rules; perform one route-specific read or safe UI action | missing interaction.json |
| `deployments` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fdeployments` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/deployments/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 部署管理: verify live data from /api/v1/deployments; perform one route-specific read or safe UI action | missing interaction.json |
| `models` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fmodels` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/models/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 模型管理: verify live data from /api/v1/models; perform one route-specific read or safe UI action | missing interaction.json |
| `mlops` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fmlops` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/mlops/interaction.template.json` | `authenticated-or-controlled-smoke-token` | MLOps 编排: verify live data from /api/v1/mlops/status, /api/v1/mlops/conditions; perform one route-specific read or safe UI action | missing interaction.json |
| `data-quality` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fdata-quality` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/data-quality/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 数据质量: verify live data from /api/v1/data-quality; perform one route-specific read or safe UI action | missing interaction.json |
| `playbooks` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fplaybooks` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/playbooks/interaction.template.json` | `authenticated-or-controlled-smoke-token` | SOAR 剧本: verify live data from /api/v1/playbooks/catalog, /api/v1/playbooks/executions; perform one route-specific read or safe UI action | missing interaction.json |
| `whitelist` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fwhitelist` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/whitelist/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 白名单: verify live data from /api/v1/whitelist; perform one route-specific read or safe UI action | missing interaction.json |
| `compliance` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fcompliance` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/compliance/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 合规审计: verify live data from /api/v1/compliance/reports, /api/v1/compliance/audit-trail; perform one route-specific read or safe UI action | missing interaction.json |
| `audit-log` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Faudit-log` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/audit-log/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 审计日志: verify live data from /api/v1/audit/logs; perform one route-specific read or safe UI action | missing interaction.json |
| `notifications` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fnotifications` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/notifications/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 通知配置: verify live data from /api/v1/notifications/settings; perform one route-specific read or safe UI action | missing interaction.json |
| `settings` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Fsettings` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/settings/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 系统设置: verify live data from /api/v1/tokens/scopes, /api/v1/tokens, /api/v1/tokens/scopes/probe; perform one route-specific read or safe UI action | missing interaction.json |
| `not-found` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2F__codex_visual_not_found__` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/not-found/interaction.template.json` | `authenticated-or-controlled-smoke-token` | render not-found recovery action and return navigation affordance | missing interaction.json |
| `topics` | `http://10.0.5.8:15175/start?nonce=%3CCODEX_SMOKE_NONCE%3E&route=%2Ftopics` | `doc/02_acceptance/02-regression/ui-visual-interaction/templates/topics/interaction.template.json` | `authenticated-or-controlled-smoke-token` | 专题面板: verify live data from /api/v1/topics/tunnel, /api/v1/topics/exfil, /api/v1/topics/apt; perform one route-specific read or safe UI action | missing interaction.json |
...
tests/e2e/ui_visual_diff_metrics.py --target-id topics --route /topics --source doc/04_assets/ui_suite_gpt_v1/screens/pages/topics-encrypted-tunnel.png --actual doc/02_acceptance/02-regression/ui-visual-interaction/latest/topics/actual-1920.png --diff doc/02_acceptance/02-regression/ui-visual-interaction/latest/topics/diff-1920.png --metrics doc/02_acceptance/02-regression/ui-visual-interaction/latest/topics/metrics.json || true
```
