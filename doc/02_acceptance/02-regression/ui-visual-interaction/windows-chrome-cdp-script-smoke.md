...
- Run ID: `windows-cdp-full-route-20260703101751`
- Result: `pass`
...
- Viewport: `1920x1080`
- Evidence dir: `evidence/windows-chrome-cdp-20260703-script-smoke`
- Acceptance dir: `doc/02_acceptance/02-regression/ui-visual-interaction/windows-cdp-smoke`
...
- `login`: mismatch=0.999301, screenshot=`evidence/windows-chrome-cdp-20260703-script-smoke/login-1920x1080.png`, diff=`doc/02_acceptance/02-regression/ui-visual-interaction/windows-cdp-smoke/login/diff-1920.png`

## Route Evidence

| route | runtime | visual diff | mismatch | screenshot | final URL |
|---|---:|---:|---:|---|---|
| `login` | pass | fail | 0.999301 | `evidence/windows-chrome-cdp-20260703-script-smoke/login-1920x1080.png` | `http://10.0.5.8:30180/login?windowsCdpEvidenceTs=1783073871573` |
