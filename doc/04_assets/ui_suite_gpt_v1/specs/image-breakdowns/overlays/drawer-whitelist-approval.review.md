# drawer-whitelist-approval.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-whitelist-approval/target.png`
...
- The target belongs to category `overlays` and is handled as `白名单审批详情`.
