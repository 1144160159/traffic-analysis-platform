...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-asset-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `编辑资产`.
