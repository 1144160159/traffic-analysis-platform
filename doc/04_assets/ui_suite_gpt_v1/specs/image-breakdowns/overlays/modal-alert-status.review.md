...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-alert-status/target.png`
...
- The target belongs to category `overlays` and is handled as `更新告警状态`.
