# drawer-mobile-navigation.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-mobile-navigation/target.png`
...
- The target belongs to category `overlays` and is handled as `移动端侧滑菜单`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-mobile-navigation.json, drawer-mobile-navigation.md, drawer-mobile-navigation.review.md
- Metric ratio: 0
