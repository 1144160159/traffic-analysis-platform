# modal-topic-report-export.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-topic-report-export/target.png`
...
- The target belongs to category `overlays` and is handled as `专题报告导出`.
