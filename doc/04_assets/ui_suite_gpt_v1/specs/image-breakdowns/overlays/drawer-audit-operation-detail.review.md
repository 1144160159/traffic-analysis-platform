# drawer-audit-operation-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-audit-operation-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `审计操作详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-audit-operation-detail.json, drawer-audit-operation-detail.md, drawer-audit-operation-detail.review.md
- Metric ratio: 0
