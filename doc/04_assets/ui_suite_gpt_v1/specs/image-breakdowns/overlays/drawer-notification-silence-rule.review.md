# drawer-notification-silence-rule.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-notification-silence-rule/target.png`
...
- The target belongs to category `overlays` and is handled as `通知静默规则`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-notification-silence-rule.json, drawer-notification-silence-rule.md, drawer-notification-silence-rule.review.md
- Metric ratio: 0
