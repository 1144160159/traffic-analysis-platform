# modal-global-search.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-global-search/target.png`
...
- The target belongs to category `overlays` and is handled as `全局搜索弹窗`.
