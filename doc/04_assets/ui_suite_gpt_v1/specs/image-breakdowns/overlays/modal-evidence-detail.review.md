# modal-evidence-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-evidence-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `证据详情`.
