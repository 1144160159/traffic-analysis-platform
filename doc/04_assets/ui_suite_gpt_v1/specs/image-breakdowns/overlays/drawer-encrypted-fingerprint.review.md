# drawer-encrypted-fingerprint.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-encrypted-fingerprint/target.png`
...
- The target belongs to category `overlays` and is handled as `加密指纹详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-encrypted-fingerprint.json, drawer-encrypted-fingerprint.md, drawer-encrypted-fingerprint.review.md
- Metric ratio: 0
