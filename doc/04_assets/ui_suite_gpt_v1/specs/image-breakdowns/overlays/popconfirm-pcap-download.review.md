# popconfirm-pcap-download.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/target.png`
...
- The target belongs to category `overlays` and is handled as `PCAP 下载确认`.
