...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-rule-publish/target.png`
...
- The target belongs to category `overlays` and is handled as `规则发布确认`.
