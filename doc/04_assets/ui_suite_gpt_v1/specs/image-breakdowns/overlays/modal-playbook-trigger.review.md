# modal-playbook-trigger.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-playbook-trigger/target.png`
...
- The target belongs to category `overlays` and is handled as `从告警触发剧本`.
