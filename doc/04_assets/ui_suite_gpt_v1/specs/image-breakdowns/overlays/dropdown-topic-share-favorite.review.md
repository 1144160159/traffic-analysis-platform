# dropdown-topic-share-favorite.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/dropdown-topic-share-favorite/target.png`
...
- The target belongs to category `overlays` and is handled as `专题分享收藏菜单`.
