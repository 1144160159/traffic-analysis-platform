# modal-fusion-rule-edit.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-fusion-rule-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `融合规则编辑`.
