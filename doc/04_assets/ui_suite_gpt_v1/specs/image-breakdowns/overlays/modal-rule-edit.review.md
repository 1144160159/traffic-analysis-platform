...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-rule-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `新建/编辑规则`.
