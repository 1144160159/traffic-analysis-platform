# drawer-graph-entity.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-graph-entity/target.png`
...
- The target belongs to category `overlays` and is handled as `图谱实体详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-graph-entity.json, drawer-graph-entity.md, drawer-graph-entity.review.md
- Metric ratio: 0
