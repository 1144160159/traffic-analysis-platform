# drawer-field-quality-sample.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-field-quality-sample/target.png`
...
- The target belongs to category `overlays` and is handled as `字段质量样例`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-field-quality-sample.json, drawer-field-quality-sample.md, drawer-field-quality-sample.review.md
- Metric ratio: 0
