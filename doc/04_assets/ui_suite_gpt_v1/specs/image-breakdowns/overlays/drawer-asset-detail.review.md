# drawer-asset-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-asset-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `资产详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-asset-detail.json, drawer-asset-detail.md, drawer-asset-detail.review.md
- Metric ratio: 0
