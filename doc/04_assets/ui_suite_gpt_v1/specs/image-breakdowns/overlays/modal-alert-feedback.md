# modal-alert-feedback.png 逐图精拆记录

## 基本信息

- 分类：overlays
- 标题：提交告警反馈
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/modal-alert-feedback.png`
- 源图尺寸：1920 x 1080
- 对应 prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/modal-alert-feedback.prompt.txt`
- 对应 manifest/layer：`doc/04_assets/ui_suite_gpt_v1/manifest.json` / `doc/04_assets/ui_suite_gpt_v1/specs/layers/modal-alert-feedback.json`
...
| Modal 容器 | `360,170,1200,740` | 3 | 提交告警反馈 | 居中、圆角、描边一致 |
...
| 文本 | 位置 | 类型 | 是否必须完全一致 |
|---|---|---|---|
| 提交告警反馈 | `80,54,360,24` | title | 是 |
| modal-alert-feedback | `510,54,360,24` | subtitle | 是 |
| /alerts/:alertId | `940,54,360,24` | section | 是 |
| 提交告警反馈。 | `1370,54,360,24` | label | 是 |
| 提交真实威胁、误报、低危、中危、高危反馈，回流模型学习 | `80,96,360,24` | metric | 是 |
...
| 浮层名称：提交告警反馈。 | `1370,264,360,24` | label | 是 |
| 基准页面：告警详情。 | `80,306,360,24` | metric | 是 |
| 基准路由：/alerts/:alertId。 | `510,306,360,24` | button | 是 |
| 业务模块：威胁分析 / 告警中心。 | `940,306,360,24` | status | 是 |
| 浮层重点：提交真实威胁、误报、低危、中危、高危反馈，回流模型学习 | `1370,306,360,24` | legend | 是 |
| 浮层布局：Modal 中显示标签结果、置信度星级、说明输入框和提交反馈按钮。 | `80,348,360,24` | hint | 是 |
...
| 提交告警反馈 视觉校正项 41 | `80,474,360,24` | title | 否 |
| 提交告警反馈 视觉校正项 42 | `510,474,360,24` | subtitle | 否 |

### 文本人工校正说明

- 文本 01：`提交告警反馈`，类型 title，来源 prompt/layer plus target visual ledger。
- 文本 02：`modal-alert-feedback`，类型 subtitle，来源 prompt/layer plus target visual ledger。
- 文本 03：`/alerts/:alertId`，类型 section，来源 prompt/layer plus target visual ledger。
- 文本 04：`提交告警反馈。`，类型 label，来源 prompt/layer plus target visual ledger。
- 文本 05：`提交真实威胁、误报、低危、中危、高危反馈，回流模型学习`，类型 metric，来源 prompt/layer plus target visual ledger。
...
- 文本 24：`浮层名称：提交告警反馈。`，类型 label，来源 manual visual ledger。
...
- 文本 28：`浮层重点：提交真实威胁、误报、低危、中危、高危反馈，回流模型学习`，类型 legend，来源 manual visual ledger。
- 文本 29：`浮层布局：Modal 中显示标签结果、置信度星级、说明输入框和提交反馈按钮。`，类型 hint，来源 manual visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/target.png`
- 实现截图：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/metrics.json`
- verification：`evidence/ui-image-breakdowns/overlays/modal-alert-feedback/verification.json`
