# modal-login-error-captcha.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-login-error-captcha/target.png`
...
- The target belongs to category `overlays` and is handled as `登录异常与验证码状态`.
