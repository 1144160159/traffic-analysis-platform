# modal-deployment-create.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-deployment-create/target.png`
...
- The target belongs to category `overlays` and is handled as `新建部署`.
...
- Raw metric remains `fail`: `0.105156 > 0.08` in `create-metrics-r20.json`.
- Effective result is `pass_with_contract_exception` only for target `deployments-create-precheck-r20`.
