# drawer-certificate-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-certificate-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `证书详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-certificate-detail.json, drawer-certificate-detail.md, drawer-certificate-detail.review.md
- Metric ratio: 0
