# modal-screen-readonly-token.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-screen-readonly-token/target.png`
...
- The target belongs to category `overlays` and is handled as `态势大屏只读令牌/脱敏配置`.
