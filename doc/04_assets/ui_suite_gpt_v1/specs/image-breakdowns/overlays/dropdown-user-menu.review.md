...
- Evidence target: `evidence/ui-image-breakdowns/overlays/dropdown-user-menu/target.png`
...
- The target belongs to category `overlays` and is handled as `用户下拉菜单`.
