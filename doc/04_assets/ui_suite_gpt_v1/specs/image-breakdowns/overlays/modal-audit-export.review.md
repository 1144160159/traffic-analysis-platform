...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-audit-export/target.png`
...
- The target belongs to category `overlays` and is handled as `审计材料导出`.
