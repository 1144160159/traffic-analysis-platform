# modal-forensics-evidence-export.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-forensics-evidence-export/target.png`
...
- The target belongs to category `overlays` and is handled as `取证证据导出`.
