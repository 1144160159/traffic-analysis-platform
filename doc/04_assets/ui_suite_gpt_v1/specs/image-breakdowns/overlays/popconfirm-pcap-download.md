# popconfirm-pcap-download.png 逐图精拆记录

## 基本信息

- 分类：overlays
- 标题：PCAP 下载确认
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/popconfirm-pcap-download.png`
- 源图尺寸：1920 x 1080
- 对应 prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/popconfirm-pcap-download.prompt.txt`
- 对应 manifest/layer：`doc/04_assets/ui_suite_gpt_v1/manifest.json` / `doc/04_assets/ui_suite_gpt_v1/specs/layers/popconfirm-pcap-download.json`
- 对应路由/宿主路由：`/forensics`
...
| 确认气泡 | `1120,164,560,500` | 3 | PCAP 下载确认 | 容器阴影、描边和圆角一致 |
...
| 文本 | 位置 | 类型 | 是否必须完全一致 |
|---|---|---|---|
| PCAP 下载确认 | `80,54,360,24` | title | 是 |
| popconfirm-pcap-download | `510,54,360,24` | subtitle | 是 |
| /forensics | `940,54,360,24` | section | 是 |
| PCAP 下载确认。 | `1370,54,360,24` | label | 是 |
| PCAP 下载确认，必须体现权限、影响范围、状态解释、下一步动作和审计留痕。 | `80,96,360,24` | metric | 是 |
...
| PCAP 下载确认 视觉校正项 41 | `80,474,360,24` | title | 否 |
| PCAP 下载确认 视觉校正项 42 | `510,474,360,24` | subtitle | 否 |

### 文本人工校正说明

- 文本 01：`PCAP 下载确认`，类型 title，来源 prompt/layer plus target visual ledger。
- 文本 02：`popconfirm-pcap-download`，类型 subtitle，来源 prompt/layer plus target visual ledger。
- 文本 03：`/forensics`，类型 section，来源 prompt/layer plus target visual ledger。
- 文本 04：`PCAP 下载确认。`，类型 label，来源 prompt/layer plus target visual ledger。
- 文本 05：`PCAP 下载确认，必须体现权限、影响范围、状态解释、下一步动作和审计留痕。`，类型 metric，来源 prompt/layer plus target visual ledger。
...
- 文本 24：`浮层名称：PCAP 下载确认。`，类型 label，来源 manual visual ledger。
...
- 文本 28：`浮层重点：PCAP 下载确认，必须体现权限、影响范围、状态解释、下一步动作和审计留痕。`，类型 legend，来源 manual visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/target.png`
- 实现截图：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/metrics.json`
- verification：`evidence/ui-image-breakdowns/overlays/popconfirm-pcap-download/verification.json`
