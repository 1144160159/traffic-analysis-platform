# modal-alert-feedback.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-alert-feedback/target.png`
...
- The target belongs to category `overlays` and is handled as `提交告警反馈`.
