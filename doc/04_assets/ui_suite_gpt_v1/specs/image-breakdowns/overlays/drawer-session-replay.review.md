# drawer-session-replay.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-session-replay/target.png`
...
- The target belongs to category `overlays` and is handled as `会话复放抽屉`.
