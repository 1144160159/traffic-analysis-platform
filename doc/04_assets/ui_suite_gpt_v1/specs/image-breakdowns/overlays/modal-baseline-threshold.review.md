# modal-baseline-threshold.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-baseline-threshold/target.png`
...
- The target belongs to category `overlays` and is handled as `基线阈值编辑`.
