# modal-settings-token.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-settings-token/target.png`
...
- The target belongs to category `overlays` and is handled as `创建 API 令牌`.
