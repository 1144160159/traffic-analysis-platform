...
- Evidence target: `evidence/ui-image-breakdowns/overlays/popconfirm-delete/target.png`
...
- The target belongs to category `overlays` and is handled as `规则删除确认`.
