# modal-topic-save-view.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-topic-save-view/target.png`
...
- The target belongs to category `overlays` and is handled as `专题保存视图`.
