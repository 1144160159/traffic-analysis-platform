# drawer-campaign-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-campaign-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `战役详情抽屉`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-campaign-detail.json, drawer-campaign-detail.md, drawer-campaign-detail.review.md
- Metric ratio: 0
