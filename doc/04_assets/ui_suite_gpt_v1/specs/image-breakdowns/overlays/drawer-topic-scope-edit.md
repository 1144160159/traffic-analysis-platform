# drawer-topic-scope-edit.png 逐图精拆记录

## 基本信息

- 分类：overlays
- 标题：专题范围编辑
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-topic-scope-edit.png`
- 源图尺寸：1920 x 1080
- 对应 prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-topic-scope-edit.prompt.txt`
- 对应 manifest/layer：`doc/04_assets/ui_suite_gpt_v1/manifest.json` / `doc/04_assets/ui_suite_gpt_v1/specs/layers/drawer-topic-scope-edit.json`
- 对应路由/宿主路由：`/topics`
...
| 抽屉容器 | `980,48,900,984` | 3 | 专题范围编辑 | 右侧固定宽度，圆角与描边一致 |
...
| 文本 | 位置 | 类型 | 是否必须完全一致 |
|---|---|---|---|
| 专题范围编辑 | `80,54,360,24` | title | 是 |
| drawer-topic-scope-edit | `510,54,360,24` | subtitle | 是 |
| /topics | `940,54,360,24` | section | 是 |
| 专题范围编辑。 | `1370,54,360,24` | label | 是 |
| 编辑专题范围、名称、时间窗、站点/资产范围、刷新周期、证据门禁和影响提示 | `80,96,360,24` | metric | 是 |
...
| 浮层名称：专题范围编辑。 | `1370,264,360,24` | label | 是 |
| 基准页面：专题面板。 | `80,306,360,24` | metric | 是 |
| 基准路由：/topics。 | `510,306,360,24` | button | 是 |
| 业务模块：综合态势 / 专题面板。 | `940,306,360,24` | status | 是 |
| 浮层重点：编辑专题范围、名称、时间窗、站点/资产范围、刷新周期、证据门禁和影响提示 | `1370,306,360,24` | legend | 是 |
| 浮层布局：右侧宽 Drawer，只展示专题范围编辑容器；左侧为基础信息和范围表单，右侧为影响预览、证据覆盖率和审计门禁。 | `80,348,360,24` | hint | 是 |
...
| 专题范围编辑 视觉校正项 41 | `80,474,360,24` | title | 否 |
| 专题范围编辑 视觉校正项 42 | `510,474,360,24` | subtitle | 否 |

### 文本人工校正说明

- 文本 01：`专题范围编辑`，类型 title，来源 prompt/layer plus target visual ledger。
- 文本 02：`drawer-topic-scope-edit`，类型 subtitle，来源 prompt/layer plus target visual ledger。
- 文本 03：`/topics`，类型 section，来源 prompt/layer plus target visual ledger。
- 文本 04：`专题范围编辑。`，类型 label，来源 prompt/layer plus target visual ledger。
- 文本 05：`编辑专题范围、名称、时间窗、站点/资产范围、刷新周期、证据门禁和影响提示`，类型 metric，来源 prompt/layer plus target visual ledger。
...
- 文本 24：`浮层名称：专题范围编辑。`，类型 label，来源 manual visual ledger。
...
- 文本 28：`浮层重点：编辑专题范围、名称、时间窗、站点/资产范围、刷新周期、证据门禁和影响提示`，类型 legend，来源 manual visual ledger。
- 文本 29：`浮层布局：右侧宽 Drawer，只展示专题范围编辑容器；左侧为基础信息和范围表单，右侧为影响预览、证据覆盖率和审计门禁。`，类型 hint，来源 manual visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/target.png`
- 实现截图：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/metrics.json`
- verification：`evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/verification.json`
