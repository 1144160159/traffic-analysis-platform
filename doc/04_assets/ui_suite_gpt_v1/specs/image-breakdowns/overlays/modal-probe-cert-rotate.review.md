# modal-probe-cert-rotate.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-probe-cert-rotate/target.png`
...
- The target belongs to category `overlays` and is handled as `证书轮换确认`.
