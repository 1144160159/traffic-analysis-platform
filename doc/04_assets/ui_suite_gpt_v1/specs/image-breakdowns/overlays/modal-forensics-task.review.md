# modal-forensics-task.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-forensics-task/target.png`
...
- The target belongs to category `overlays` and is handled as `取证任务详情`.
