# drawer-compliance-gate-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-compliance-gate-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `合规门禁详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-compliance-gate-detail.json, drawer-compliance-gate-detail.md, drawer-compliance-gate-detail.review.md
- Metric ratio: 0
