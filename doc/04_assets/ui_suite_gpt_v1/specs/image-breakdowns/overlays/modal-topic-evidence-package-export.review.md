# modal-topic-evidence-package-export.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-topic-evidence-package-export/target.png`
...
- The target belongs to category `overlays` and is handled as `专题证据包导出`.
