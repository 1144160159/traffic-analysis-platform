# drawer-attack-chain-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-attack-chain-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `攻击链详情抽屉`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-attack-chain-detail.json, drawer-attack-chain-detail.md, drawer-attack-chain-detail.review.md
- Metric ratio: 0
