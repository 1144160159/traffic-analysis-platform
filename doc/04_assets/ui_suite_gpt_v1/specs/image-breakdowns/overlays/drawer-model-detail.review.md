# drawer-model-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-model-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `模型详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-model-detail.json, drawer-model-detail.md, drawer-model-detail.review.md
- Metric ratio: 0
