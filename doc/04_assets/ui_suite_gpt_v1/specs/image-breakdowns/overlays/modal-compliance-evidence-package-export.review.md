# modal-compliance-evidence-package-export.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-compliance-evidence-package-export/target.png`
...
- The target belongs to category `overlays` and is handled as `合规证据包导出`.
