# modal-probe-batch-upgrade.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-probe-batch-upgrade/target.png`
...
- The target belongs to category `overlays` and is handled as `探针批量升级确认`.
