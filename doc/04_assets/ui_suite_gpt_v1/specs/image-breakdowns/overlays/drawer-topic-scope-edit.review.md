# drawer-topic-scope-edit.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-topic-scope-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `专题范围编辑`.
