# drawer-topic-subscription.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-topic-subscription/target.png`
...
- The target belongs to category `overlays` and is handled as `专题订阅配置`.
