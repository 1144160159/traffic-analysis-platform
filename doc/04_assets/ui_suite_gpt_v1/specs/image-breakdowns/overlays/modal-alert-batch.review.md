...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-alert-batch/target.png`
...
- The target belongs to category `overlays` and is handled as `告警批量操作确认`.
