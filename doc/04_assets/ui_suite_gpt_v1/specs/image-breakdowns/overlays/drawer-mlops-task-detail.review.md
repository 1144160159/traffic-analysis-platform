# drawer-mlops-task-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-mlops-task-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `MLOps 任务详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-mlops-task-detail.json, drawer-mlops-task-detail.md, drawer-mlops-task-detail.review.md
- Metric ratio: 0
