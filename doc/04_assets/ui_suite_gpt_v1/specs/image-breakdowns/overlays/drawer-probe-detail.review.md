# drawer-probe-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-probe-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `探针详情`.
