# dropdown-alert-row-actions.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/dropdown-alert-row-actions/target.png`
...
- The target belongs to category `overlays` and is handled as `告警行操作下拉`.
