# drawer-asset-history.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-asset-history/target.png`
...
- The target belongs to category `overlays` and is handled as `资产历史`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-asset-history.json, drawer-asset-history.md, drawer-asset-history.review.md
- Metric ratio: 0
