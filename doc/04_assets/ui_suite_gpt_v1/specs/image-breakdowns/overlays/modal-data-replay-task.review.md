# modal-data-replay-task.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-data-replay-task/target.png`
...
- The target belongs to category `overlays` and is handled as `数据重放任务`.
