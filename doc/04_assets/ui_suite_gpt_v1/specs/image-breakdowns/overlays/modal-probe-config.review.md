...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-probe-config/target.png`
...
- The target belongs to category `overlays` and is handled as `探针配置下发`.
