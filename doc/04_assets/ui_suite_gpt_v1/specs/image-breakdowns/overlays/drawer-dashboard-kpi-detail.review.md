# drawer-dashboard-kpi-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-dashboard-kpi-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `仪表盘 KPI 详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-dashboard-kpi-detail.json, drawer-dashboard-kpi-detail.md, drawer-dashboard-kpi-detail.review.md
- Metric ratio: 0
