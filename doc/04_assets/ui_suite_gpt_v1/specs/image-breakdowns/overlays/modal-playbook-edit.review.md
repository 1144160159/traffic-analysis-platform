# modal-playbook-edit.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-playbook-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `剧本编辑`.
