# modal-whitelist-draft-from-alert.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-whitelist-draft-from-alert/target.png`
...
- The target belongs to category `overlays` and is handled as `从告警生成白名单草案`.
