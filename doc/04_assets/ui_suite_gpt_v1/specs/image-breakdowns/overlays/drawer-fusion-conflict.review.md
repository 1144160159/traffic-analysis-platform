# drawer-fusion-conflict.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-fusion-conflict/target.png`
...
- The target belongs to category `overlays` and is handled as `数据融合冲突处理`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-fusion-conflict.json, drawer-fusion-conflict.md, drawer-fusion-conflict.review.md
- Metric ratio: 0
