# drawer-settings-rbac-edit.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-settings-rbac-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `RBAC 权限编辑`.
