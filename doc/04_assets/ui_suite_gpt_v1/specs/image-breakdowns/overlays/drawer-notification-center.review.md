# drawer-notification-center.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-notification-center/target.png`
...
- The target belongs to category `overlays` and is handled as `通知中心抽屉`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-notification-center.json, drawer-notification-center.md, drawer-notification-center.review.md
- Metric ratio: 0
