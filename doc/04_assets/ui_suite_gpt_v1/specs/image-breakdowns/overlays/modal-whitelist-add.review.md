# modal-whitelist-add.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-whitelist-add/target.png`
...
- The target belongs to category `overlays` and is handled as `添加白名单`.
