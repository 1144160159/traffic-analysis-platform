# popconfirm-settings-token-revoke.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/popconfirm-settings-token-revoke/target.png`
...
- The target belongs to category `overlays` and is handled as `API 令牌吊销确认`.
