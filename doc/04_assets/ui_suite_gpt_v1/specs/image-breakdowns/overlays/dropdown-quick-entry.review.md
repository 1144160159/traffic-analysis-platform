# dropdown-quick-entry.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/dropdown-quick-entry/target.png`
...
- The target belongs to category `overlays` and is handled as `快速入口下拉`.
