# modal-notification-channel-edit.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-notification-channel-edit/target.png`
...
- The target belongs to category `overlays` and is handled as `通知渠道编辑`.
