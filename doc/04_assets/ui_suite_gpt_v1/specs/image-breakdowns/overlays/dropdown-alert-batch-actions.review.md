# dropdown-alert-batch-actions.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/dropdown-alert-batch-actions/target.png`
...
- The target belongs to category `overlays` and is handled as `告警批量操作下拉`.
