# modal-campaign-report-export.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-campaign-report-export/target.png`
...
- The target belongs to category `overlays` and is handled as `战役报告导出`.
