# drawer-dashboard-task-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-dashboard-task-detail/target.png`
...
- The target belongs to category `overlays` and is handled as `待办任务详情`.
...
- Evidence checked: target.png, implementation.png, diff.png, metrics.json, regions-overlay.png, measurement.json, text-ocr.txt, capture-meta.json, verification.json, drawer-dashboard-task-detail.json, drawer-dashboard-task-detail.md, drawer-dashboard-task-detail.review.md
- Metric ratio: 0
