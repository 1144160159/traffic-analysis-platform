# modal-notification-template-preview-test.png review
...
- Evidence target: `evidence/ui-image-breakdowns/overlays/modal-notification-template-preview-test/target.png`
...
- The target belongs to category `overlays` and is handled as `通知模板预览测试`.
