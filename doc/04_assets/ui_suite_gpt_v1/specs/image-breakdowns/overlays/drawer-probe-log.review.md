...
- Evidence target: `evidence/ui-image-breakdowns/overlays/drawer-probe-log/target.png`
...
- The target belongs to category `overlays` and is handled as `探针日志抽屉`.
