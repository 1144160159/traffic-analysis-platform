# responsive-alerts-1920.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-alerts-1920/target.png`
...
- The target belongs to category `responsive` and is handled as `告警中心 1920x1080`.
