# responsive-mobile-navigation.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-mobile-navigation/target.png`
...
- The target belongs to category `responsive` and is handled as `移动端导航抽屉适配策略`.
