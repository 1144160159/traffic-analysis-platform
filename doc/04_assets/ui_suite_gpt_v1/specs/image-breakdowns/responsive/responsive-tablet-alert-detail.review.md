# responsive-tablet-alert-detail.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-tablet-alert-detail/target.png`
...
- The target belongs to category `responsive` and is handled as `平板告警详情适配策略`.
