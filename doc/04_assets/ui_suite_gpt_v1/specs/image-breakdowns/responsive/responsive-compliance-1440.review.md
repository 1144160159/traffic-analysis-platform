# responsive-compliance-1440.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-compliance-1440/target.png`
...
- The target belongs to category `responsive` and is handled as `合规审计 1440 视口适配策略`.
