# responsive-dashboard-1920.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-dashboard-1920/target.png`
...
- The target belongs to category `responsive` and is handled as `仪表盘 1920x1080`.
