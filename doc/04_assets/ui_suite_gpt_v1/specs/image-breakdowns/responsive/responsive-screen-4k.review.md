# responsive-screen-4k.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-screen-4k/target.png`
...
- The target belongs to category `responsive` and is handled as `态势大屏 4K 视口适配策略`.
