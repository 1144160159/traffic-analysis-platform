# responsive-mobile-alert-list.png review
...
- Evidence target: `evidence/ui-image-breakdowns/responsive/responsive-mobile-alert-list/target.png`
...
- The target belongs to category `responsive` and is handled as `移动端告警列表适配策略`.
