...
- Evidence target: `evidence/ui-image-breakdowns/states/state-task-running/target.png`
...
- The target belongs to category `states` and is handled as `任务运行中`.
