...
- Evidence target: `evidence/ui-image-breakdowns/states/state-empty-page/target.png`
...
- The target belongs to category `states` and is handled as `页面空数据`.
