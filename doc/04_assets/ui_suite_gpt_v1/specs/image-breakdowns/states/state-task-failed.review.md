...
- Evidence target: `evidence/ui-image-breakdowns/states/state-task-failed/target.png`
...
- The target belongs to category `states` and is handled as `任务失败可重试`.
