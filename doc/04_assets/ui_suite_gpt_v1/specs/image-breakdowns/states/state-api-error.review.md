...
- Evidence target: `evidence/ui-image-breakdowns/states/state-api-error/target.png`
...
- The target belongs to category `states` and is handled as `API 错误`.
