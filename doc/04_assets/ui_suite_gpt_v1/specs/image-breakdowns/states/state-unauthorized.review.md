...
- Evidence target: `evidence/ui-image-breakdowns/states/state-unauthorized/target.png`
...
- The target belongs to category `states` and is handled as `未登录`.
