# state-offline-probe.png review
...
- Evidence target: `evidence/ui-image-breakdowns/states/state-offline-probe/target.png`
...
- The target belongs to category `states` and is handled as `探针离线`.
