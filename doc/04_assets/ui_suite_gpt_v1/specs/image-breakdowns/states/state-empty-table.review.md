...
- Evidence target: `evidence/ui-image-breakdowns/states/state-empty-table/target.png`
...
- The target belongs to category `states` and is handled as `表格空数据`.
