...
- Evidence target: `evidence/ui-image-breakdowns/states/state-forbidden/target.png`
...
- The target belongs to category `states` and is handled as `无权限`.
