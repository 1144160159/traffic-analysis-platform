...
- Evidence target: `evidence/ui-image-breakdowns/states/state-page-loading/target.png`
...
- The target belongs to category `states` and is handled as `页面加载中`.
