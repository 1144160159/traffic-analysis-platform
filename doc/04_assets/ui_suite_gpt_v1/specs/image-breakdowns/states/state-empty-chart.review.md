...
- Evidence target: `evidence/ui-image-breakdowns/states/state-empty-chart/target.png`
...
- The target belongs to category `states` and is handled as `图表空数据`.
