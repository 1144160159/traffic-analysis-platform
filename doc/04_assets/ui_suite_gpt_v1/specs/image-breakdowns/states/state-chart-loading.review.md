# state-chart-loading.png review
...
- Evidence target: `evidence/ui-image-breakdowns/states/state-chart-loading/target.png`
...
- The target belongs to category `states` and is handled as `图表加载中`.
