# state-network-error.png review
...
- Evidence target: `evidence/ui-image-breakdowns/states/state-network-error/target.png`
...
- The target belongs to category `states` and is handled as `网络异常`.
