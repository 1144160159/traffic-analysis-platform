# state-table-loading.png review
...
- Evidence target: `evidence/ui-image-breakdowns/states/state-table-loading/target.png`
...
- The target belongs to category `states` and is handled as `表格加载中`.
