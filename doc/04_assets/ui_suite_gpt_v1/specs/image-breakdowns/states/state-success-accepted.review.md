# state-success-accepted.png review
...
- Evidence target: `evidence/ui-image-breakdowns/states/state-success-accepted/target.png`
...
- The target belongs to category `states` and is handled as `验收通过/操作成功`.
