# state-partial-degraded.png review
...
- Evidence target: `evidence/ui-image-breakdowns/states/state-partial-degraded/target.png`
...
- The target belongs to category `states` and is handled as `部分降级`.
