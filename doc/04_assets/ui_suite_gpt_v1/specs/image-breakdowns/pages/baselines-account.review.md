...
- Evidence target: `evidence/ui-image-breakdowns/pages/baselines-account/target.png`
...
| Visual diff | pass | Canonical `content-root` ROI is `0.08635314114474686`, within `0.125` at channel tolerance `90` |
...
|---|---|---|---|---|
| visual-diff | content-root | canonical production screenshot ROI is `0.08635314114474686` at tolerance `90` | mismatch ratio <= `0.125` | closed |
...
- Canonical result: `content-root` ROI `0.08635314114474686` passes threshold `0.125` at tolerance `90`.
- Verdict: `changes-required`; the screenshot remains on the asset baseline tab and does not prove the account baseline target state.
