# audit-log-related-chain.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/audit-log-related-chain/target.png`
...
| Visual diff | pass | Canonical `content-root` ROI is `0.08605803147920871`, within `0.125` at channel tolerance `90` |
...
|---|---|---|---|---|
| visual-diff | content-root | canonical production screenshot ROI is `0.08605803147920871` at tolerance `90` | mismatch ratio <= `0.125` | closed |
...
- Canonical result: `content-root` ROI `0.08605803147920871` passes threshold `0.125` at tolerance `90`.
- Verdict: `changes-required`; the related-chain target substate is not reached by a dedicated production route-state mapping.
