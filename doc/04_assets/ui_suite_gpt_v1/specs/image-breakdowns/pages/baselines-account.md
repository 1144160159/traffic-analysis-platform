# baselines-account.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：行为基准。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/baselines-account.png`
- 源图尺寸：1920 x 1080
...
| baselines-account | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`baselines-account`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/baselines-account/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/baselines-account/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/baselines-account/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/baselines-account/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/baselines-account/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/baselines-account/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/baselines-account/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/baselines-account/verification.json`
