...
- Evidence target: `evidence/ui-image-breakdowns/pages/not-found/target.png`
...
- The target belongs to category `pages` and is handled as `404 异常页`.
