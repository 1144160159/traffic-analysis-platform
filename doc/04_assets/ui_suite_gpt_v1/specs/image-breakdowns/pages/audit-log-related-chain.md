# audit-log-related-chain.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：审计日志。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/audit-log-related-chain.png`
- 源图尺寸：1920 x 1080
...
| audit-log-related-chain | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`audit-log-related-chain`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/audit-log-related-chain/verification.json`
