# models-feature-sample-examples.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：模型管理。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/models-feature-sample-examples.png`
- 源图尺寸：1920 x 1080
...
| models-feature-sample-examples | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`models-feature-sample-examples`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/models-feature-sample-examples/verification.json`
