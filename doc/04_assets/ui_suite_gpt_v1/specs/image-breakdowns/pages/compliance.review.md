...
- Evidence target: `evidence/ui-image-breakdowns/pages/compliance/target.png`
...
- The target belongs to category `pages` and is handled as `合规审计`.
