...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-server/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.11235572240439651 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
