# graph-communication-path.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：实体图谱。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/graph-communication-path.png`
- 源图尺寸：1920 x 1080
...
| graph-communication-path | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`graph-communication-path`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/graph-communication-path/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/graph-communication-path/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/graph-communication-path/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/graph-communication-path/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/graph-communication-path/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/graph-communication-path/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/graph-communication-path/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/graph-communication-path/verification.json`
