# assets-detail-network-interface.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-detail-network-interface/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.09138457095740922 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
