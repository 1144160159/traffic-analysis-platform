# whitelist-condition-model.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：白名单。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/whitelist-condition-model.png`
- 源图尺寸：1920 x 1080
...
| whitelist-condition-model | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`whitelist-condition-model`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/whitelist-condition-model/verification.json`
