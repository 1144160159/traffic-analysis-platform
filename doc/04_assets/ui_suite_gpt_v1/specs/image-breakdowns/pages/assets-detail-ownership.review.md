# assets-detail-ownership.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-detail-ownership/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.09406905566173593 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
