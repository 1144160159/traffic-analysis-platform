...
- Evidence target: `evidence/ui-image-breakdowns/pages/baselines/target.png`
...
| Visual diff | pass | Canonical `content-root` ROI is `0.07926607619402257`, within `0.125` at channel tolerance `90` |
...
|---|---|---|---|---|
| visual-diff | content-root | canonical production screenshot ROI is `0.07926607619402257` at tolerance `90` | mismatch ratio <= `0.125` | closed |
...
- Confirmed: implementation is the real Windows Chrome production `/baselines` base page and is not target raster replay.
- Canonical result: `content-root` ROI `0.07926607619402257` passes threshold `0.125` at tolerance `90`.
- Verdict: `reviewed`; this base route may proceed to a separate main-thread decision, but this stage does not claim acceptance.
