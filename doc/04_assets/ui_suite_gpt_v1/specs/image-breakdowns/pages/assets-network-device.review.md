# assets-network-device.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-network-device/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.11251340975787075 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
