# assets-business-system.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-business-system/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.10801583712986218 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
