...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.10808993118751876 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
