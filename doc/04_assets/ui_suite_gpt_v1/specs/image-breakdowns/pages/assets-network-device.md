# assets-network-device.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：资产台账。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/assets-network-device.png`
- 源图尺寸：1920 x 1080
...
| assets-network-device | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`assets-network-device`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/assets-network-device/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/assets-network-device/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/assets-network-device/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/assets-network-device/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/assets-network-device/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/assets-network-device/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/assets-network-device/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/assets-network-device/verification.json`
