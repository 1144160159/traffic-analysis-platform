# models-feature-anomaly-explanation.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：模型管理。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/models-feature-anomaly-explanation.png`
- 源图尺寸：1920 x 1080
...
| models-feature-anomaly-explanation | `510,54,360,24` | subtitle | 是 |
| /models | `940,54,360,24` | section | 是 |
| 管理 AI/行为检测模型的版本、指标、数据集、解释和在线状态。 | `1370,54,360,24` | label | 是 |
...
| 左侧二级菜单显示：规则管理、部署管理、模型管理、MLOps 编排、SOAR 剧本、白名单，当前高亮“模型管理”。 | `940,138,360,24` | title | 是 |
...
| 页面名称：模型管理。 | `1370,180,360,24` | button | 是 |
| 路由：/models。 | `80,222,360,24` | status | 是 |
| 业务模块：检测运营 / 模型管理。 | `510,222,360,24` | legend | 是 |
| 页面重点：管理 AI/行为检测模型的版本、指标、数据集、解释和在线状态。 | `940,222,360,24` | hint | 是 |
| 必须包含的业务模块： | `1370,222,360,24` | acceptance | 是 |
| - 模型列表：模型名、类型、版本、状态、线上版本、训练时间、负责人。 | `80,264,360,24` | title | 是 |
| - 模型指标：准确率、召回率、F1、AUC、误报率、漂移、置信区间。 | `510,264,360,24` | subtitle | 是 |
...
- 文本 02：`models-feature-anomaly-explanation`，类型 subtitle，来源 prompt/layer plus target visual ledger。
- 文本 03：`/models`，类型 section，来源 prompt/layer plus target visual ledger。
- 文本 04：`管理 AI/行为检测模型的版本、指标、数据集、解释和在线状态。`，类型 label，来源 prompt/layer plus target visual ledger。
...
- 文本 11：`左侧二级菜单显示：规则管理、部署管理、模型管理、MLOps 编排、SOAR 剧本、白名单，当前高亮“模型管理”。`，类型 title，来源 prompt/layer plus target visual ledger。
...
- 文本 16：`页面名称：模型管理。`，类型 button，来源 prompt/layer plus target visual ledger。
- 文本 17：`路由：/models。`，类型 status，来源 prompt/layer plus target visual ledger。
- 文本 18：`业务模块：检测运营 / 模型管理。`，类型 legend，来源 prompt/layer plus target visual ledger。
- 文本 19：`页面重点：管理 AI/行为检测模型的版本、指标、数据集、解释和在线状态。`，类型 hint，来源 manual visual ledger。
- 文本 20：`必须包含的业务模块：`，类型 acceptance，来源 manual visual ledger。
- 文本 21：`- 模型列表：模型名、类型、版本、状态、线上版本、训练时间、负责人。`，类型 title，来源 manual visual ledger。
- 文本 22：`- 模型指标：准确率、召回率、F1、AUC、误报率、漂移、置信区间。`，类型 subtitle，来源 manual visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/models-feature-anomaly-explanation/verification.json`
