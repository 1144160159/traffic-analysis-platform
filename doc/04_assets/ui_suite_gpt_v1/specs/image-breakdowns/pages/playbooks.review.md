...
- Evidence target: `evidence/ui-image-breakdowns/pages/playbooks/target.png`
...
- The target belongs to category `pages` and is handled as `SOAR 剧本`.
