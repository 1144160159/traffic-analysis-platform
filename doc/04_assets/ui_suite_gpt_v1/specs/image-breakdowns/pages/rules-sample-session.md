# rules-sample-session.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：规则管理。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/rules-sample-session.png`
- 源图尺寸：1920 x 1080
...
| rules-sample-session | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`rules-sample-session`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/rules-sample-session/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/rules-sample-session/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/rules-sample-session/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/rules-sample-session/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/rules-sample-session/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/rules-sample-session/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/rules-sample-session/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/rules-sample-session/verification.json`
