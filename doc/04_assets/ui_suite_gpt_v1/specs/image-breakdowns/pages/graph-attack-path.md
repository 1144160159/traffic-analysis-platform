# graph-attack-path.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：实体图谱。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/graph-attack-path.png`
- 源图尺寸：1920 x 1080
...
| graph-attack-path | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`graph-attack-path`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/graph-attack-path/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/graph-attack-path/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/graph-attack-path/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/graph-attack-path/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/graph-attack-path/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/graph-attack-path/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/graph-attack-path/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/graph-attack-path/verification.json`
