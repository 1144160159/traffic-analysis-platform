# models-activation-audit-gate.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：模型管理。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/models-activation-audit-gate.png`
- 源图尺寸：1920 x 1080
...
| models-activation-audit-gate | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`models-activation-audit-gate`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/models-activation-audit-gate/verification.json`
