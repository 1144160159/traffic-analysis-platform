# baselines-port.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：行为基准。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/baselines-port.png`
- 源图尺寸：1920 x 1080
...
| baselines-port | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`baselines-port`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/baselines-port/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/baselines-port/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/baselines-port/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/baselines-port/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/baselines-port/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/baselines-port/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/baselines-port/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/baselines-port/verification.json`
