# assets-detail-open-services.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-detail-open-services/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.11334111004297455 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
