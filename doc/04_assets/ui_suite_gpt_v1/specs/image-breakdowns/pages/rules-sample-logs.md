# rules-sample-logs.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：规则管理。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/rules-sample-logs.png`
- 源图尺寸：1920 x 1080
...
| rules-sample-logs | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`rules-sample-logs`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/rules-sample-logs/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/rules-sample-logs/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/rules-sample-logs/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/rules-sample-logs/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/rules-sample-logs/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/rules-sample-logs/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/rules-sample-logs/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/rules-sample-logs/verification.json`
