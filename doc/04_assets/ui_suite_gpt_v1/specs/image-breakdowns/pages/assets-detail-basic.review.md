# assets-detail-basic.png review
...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-detail-basic/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.10243535135148828 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
