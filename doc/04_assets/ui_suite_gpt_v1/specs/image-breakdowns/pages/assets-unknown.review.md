...
- Evidence target: `evidence/ui-image-breakdowns/pages/assets-unknown/target.png`
...
|---|---|---|---|---|
| visual-diff | business scoring region | business-region pixel mismatch ratio 0.12026035511951942 (content-root: 198,80 1722x917) | business-region pixel mismatch ratio <= 0.125 | accepted |
