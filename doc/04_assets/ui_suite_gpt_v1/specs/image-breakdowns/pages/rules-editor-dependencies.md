# rules-editor-dependencies.png 逐图精拆记录

## 基本信息

- 分类：pages
- 标题：规则管理。
- 源图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/rules-editor-dependencies.png`
- 源图尺寸：1920 x 1080
...
| rules-editor-dependencies | `510,54,360,24` | subtitle | 是 |
...
- 文本 02：`rules-editor-dependencies`，类型 subtitle，来源 prompt/layer plus target visual ledger。
...
- 目标图：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/target.png`
- 实现截图：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/implementation.png`
- diff 图：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/diff.png`
- regions overlay：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/regions-overlay.png`
- measurement：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/measurement.json`
- OCR/manual ledger：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/text-ocr.txt`
- metrics：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/metrics.json`
- verification：`evidence/ui-image-breakdowns/pages/rules-editor-dependencies/verification.json`
