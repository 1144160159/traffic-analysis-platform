# component-risk-score.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-risk-score/target.png`
...
- The target belongs to category `components` and is handled as `风险评分`.
