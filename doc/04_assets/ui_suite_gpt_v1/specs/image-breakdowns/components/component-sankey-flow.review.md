# component-sankey-flow.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-sankey-flow/target.png`
...
- The target belongs to category `components` and is handled as `桑基流向图`.
