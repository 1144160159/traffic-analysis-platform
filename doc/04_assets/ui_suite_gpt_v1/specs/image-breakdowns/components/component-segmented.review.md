# component-segmented.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-segmented/target.png`
...
- The target belongs to category `components` and is handled as `Segmented`.
