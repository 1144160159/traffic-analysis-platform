...
- Evidence target: `evidence/ui-image-breakdowns/components/component-tooltip/target.png`
...
- The target belongs to category `components` and is handled as `Tooltip`.
