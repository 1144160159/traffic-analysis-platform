# component-ranking-list.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-ranking-list/target.png`
...
- The target belongs to category `components` and is handled as `排行列表`.
