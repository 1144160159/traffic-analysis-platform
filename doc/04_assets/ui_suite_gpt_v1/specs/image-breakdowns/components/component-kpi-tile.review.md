...
- Evidence target: `evidence/ui-image-breakdowns/components/component-kpi-tile/target.png`
...
- The target belongs to category `components` and is handled as `KPI 卡`.
