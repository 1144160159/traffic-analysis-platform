# component-evidence-drawer.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-evidence-drawer/target.png`
...
- The target belongs to category `components` and is handled as `证据抽屉`.
