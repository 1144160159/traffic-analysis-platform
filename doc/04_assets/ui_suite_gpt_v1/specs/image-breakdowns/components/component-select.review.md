...
- Evidence target: `evidence/ui-image-breakdowns/components/component-select/target.png`
...
- The target belongs to category `components` and is handled as `选择器`.
