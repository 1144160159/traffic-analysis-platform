# component-data-table.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-data-table/target.png`
...
- The target belongs to category `components` and is handled as `高密度表格`.
