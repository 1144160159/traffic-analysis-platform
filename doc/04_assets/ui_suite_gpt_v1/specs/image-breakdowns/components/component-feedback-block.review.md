# component-feedback-block.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-feedback-block/target.png`
...
- The target belongs to category `components` and is handled as `反馈学习块`.
