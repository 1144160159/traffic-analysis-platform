# component-empty-card.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-empty-card/target.png`
...
- The target belongs to category `components` and is handled as `空状态卡`.
