# component-pagination.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-pagination/target.png`
...
- The target belongs to category `components` and is handled as `Pagination`.
