# component-icon-button.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-icon-button/target.png`
...
- The target belongs to category `components` and is handled as `图标按钮`.
