...
- Evidence target: `evidence/ui-image-breakdowns/components/component-input/target.png`
...
- The target belongs to category `components` and is handled as `输入框`.
