# component-condition-builder.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-condition-builder/target.png`
...
- The target belongs to category `components` and is handled as `条件构造器`.
