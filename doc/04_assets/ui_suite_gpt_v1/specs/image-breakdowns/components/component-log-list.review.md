...
- Evidence target: `evidence/ui-image-breakdowns/components/component-log-list/target.png`
...
- The target belongs to category `components` and is handled as `日志列表`.
