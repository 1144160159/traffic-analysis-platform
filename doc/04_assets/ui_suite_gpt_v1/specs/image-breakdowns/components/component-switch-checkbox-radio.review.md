# component-switch-checkbox-radio.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-switch-checkbox-radio/target.png`
...
- The target belongs to category `components` and is handled as `开关/复选/单选`.
