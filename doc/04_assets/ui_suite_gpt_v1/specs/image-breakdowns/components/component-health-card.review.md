# component-health-card.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-health-card/target.png`
...
- The target belongs to category `components` and is handled as `状态卡`.
