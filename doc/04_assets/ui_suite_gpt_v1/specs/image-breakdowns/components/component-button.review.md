...
- Evidence target: `evidence/ui-image-breakdowns/components/component-button/target.png`
...
- The target belongs to category `components` and is handled as `按钮`.
