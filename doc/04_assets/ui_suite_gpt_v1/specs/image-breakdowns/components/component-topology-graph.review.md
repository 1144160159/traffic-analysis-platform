# component-topology-graph.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-topology-graph/target.png`
...
- The target belongs to category `components` and is handled as `拓扑/图谱`.
