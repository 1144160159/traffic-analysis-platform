# component-description-list.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-description-list/target.png`
...
- The target belongs to category `components` and is handled as `详情描述列表`.
