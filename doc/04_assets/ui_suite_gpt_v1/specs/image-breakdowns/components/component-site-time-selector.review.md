# component-site-time-selector.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-site-time-selector/target.png`
...
- The target belongs to category `components` and is handled as `站点与时间选择`.
