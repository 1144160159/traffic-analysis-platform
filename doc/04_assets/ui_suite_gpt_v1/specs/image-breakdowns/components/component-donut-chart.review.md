# component-donut-chart.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-donut-chart/target.png`
...
- The target belongs to category `components` and is handled as `环图`.
