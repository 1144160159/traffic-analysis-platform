# component-radar-quality.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-radar-quality/target.png`
...
- The target belongs to category `components` and is handled as `雷达/质量评分`.
