# component-user-menu.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-user-menu/target.png`
...
- The target belongs to category `components` and is handled as `用户菜单`.
