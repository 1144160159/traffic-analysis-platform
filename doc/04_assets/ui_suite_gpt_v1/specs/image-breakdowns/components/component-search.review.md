...
- Evidence target: `evidence/ui-image-breakdowns/components/component-search/target.png`
...
- The target belongs to category `components` and is handled as `搜索框`.
