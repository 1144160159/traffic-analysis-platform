...
- Evidence target: `evidence/ui-image-breakdowns/components/component-heatmap/target.png`
...
- The target belongs to category `components` and is handled as `热力图`.
