# component-secondary-menu.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-secondary-menu/target.png`
...
- The target belongs to category `components` and is handled as `二级菜单`.
