# component-quick-entry.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-quick-entry/target.png`
...
- The target belongs to category `components` and is handled as `快速入口`.
