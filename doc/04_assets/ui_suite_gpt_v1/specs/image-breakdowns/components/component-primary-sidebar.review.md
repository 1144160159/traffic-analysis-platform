# component-primary-sidebar.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-primary-sidebar/target.png`
...
- The target belongs to category `components` and is handled as `左侧一级导航`.
