# component-status-chip.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-status-chip/target.png`
...
- The target belongs to category `components` and is handled as `标签与 Badge`.
