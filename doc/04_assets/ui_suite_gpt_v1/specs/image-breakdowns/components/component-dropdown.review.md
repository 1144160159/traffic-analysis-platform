...
- Evidence target: `evidence/ui-image-breakdowns/components/component-dropdown/target.png`
...
- The target belongs to category `components` and is handled as `Dropdown`.
