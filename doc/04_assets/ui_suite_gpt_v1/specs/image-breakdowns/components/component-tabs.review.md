...
- Evidence target: `evidence/ui-image-breakdowns/components/component-tabs/target.png`
...
- The target belongs to category `components` and is handled as `Tabs`.
