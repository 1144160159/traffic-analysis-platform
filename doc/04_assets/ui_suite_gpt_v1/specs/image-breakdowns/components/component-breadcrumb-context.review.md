# component-breadcrumb-context.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-breadcrumb-context/target.png`
...
- The target belongs to category `components` and is handled as `面包屑与上下文条`.
