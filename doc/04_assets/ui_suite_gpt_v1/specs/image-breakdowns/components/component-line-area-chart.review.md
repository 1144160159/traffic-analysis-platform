# component-line-area-chart.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-line-area-chart/target.png`
...
- The target belongs to category `components` and is handled as `折线/面积图`.
