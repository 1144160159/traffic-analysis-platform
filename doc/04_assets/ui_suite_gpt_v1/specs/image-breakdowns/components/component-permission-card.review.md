# component-permission-card.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-permission-card/target.png`
...
- The target belongs to category `components` and is handled as `权限提示卡`.
