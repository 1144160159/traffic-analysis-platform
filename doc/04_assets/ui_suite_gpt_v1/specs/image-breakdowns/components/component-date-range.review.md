# component-date-range.png review
...
- Evidence target: `evidence/ui-image-breakdowns/components/component-date-range/target.png`
...
- The target belongs to category `components` and is handled as `日期时间窗`.
