...
- 宿主路由：`/audit-log`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-audit-operation-detail.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-audit-operation-detail.prompt.txt`
