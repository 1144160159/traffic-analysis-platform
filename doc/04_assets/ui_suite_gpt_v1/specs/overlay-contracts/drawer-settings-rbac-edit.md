...
- ID：`drawer-settings-rbac-edit`
- 宿主路由：`/settings`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-settings-rbac-edit.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-settings-rbac-edit.prompt.txt`
