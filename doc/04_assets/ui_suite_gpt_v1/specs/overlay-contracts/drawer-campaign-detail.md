...
- 宿主路由：`/campaigns`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-campaign-detail.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-campaign-detail.prompt.txt`
