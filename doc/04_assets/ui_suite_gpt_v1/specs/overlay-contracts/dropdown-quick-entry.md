...
- ID：`dropdown-quick-entry`
- 宿主路由：`/dashboard`
- 推荐组件：`Dropdown/Menu`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/dropdown-quick-entry.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/dropdown-quick-entry.prompt.txt`
