...
- 宿主路由：`/topics`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-topic-subscription.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-topic-subscription.prompt.txt`
