...
- ID：`drawer-asset-history`
- 宿主路由：`/assets`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-asset-history.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-asset-history.prompt.txt`
