...
- 宿主路由：`/whitelist`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-whitelist-approval.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-whitelist-approval.prompt.txt`
