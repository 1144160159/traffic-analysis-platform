...
- ID：`drawer-asset-detail`
- 宿主路由：`/assets`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-asset-detail.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-asset-detail.prompt.txt`
