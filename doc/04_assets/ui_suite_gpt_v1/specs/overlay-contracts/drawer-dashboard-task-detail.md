...
- 宿主路由：`/dashboard`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-dashboard-task-detail.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-dashboard-task-detail.prompt.txt`
