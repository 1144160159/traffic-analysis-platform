...
- 宿主路由：`/forensics`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-session-replay.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-session-replay.prompt.txt`
