...
- 宿主路由：`/forensics`
- 推荐组件：`Modal`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/modal-forensics-evidence-export.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/modal-forensics-evidence-export.prompt.txt`
