...
- ID：`drawer-notification-center`
- 宿主路由：`/notifications`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-notification-center.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-notification-center.prompt.txt`
