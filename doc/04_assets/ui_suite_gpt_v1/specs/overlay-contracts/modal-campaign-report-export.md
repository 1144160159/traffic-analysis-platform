...
- 推荐组件：`Modal`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/modal-campaign-report-export.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/modal-campaign-report-export.prompt.txt`
