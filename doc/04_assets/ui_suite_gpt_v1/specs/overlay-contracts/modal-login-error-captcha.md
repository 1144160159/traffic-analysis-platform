...
- 宿主路由：`/login`
- 推荐组件：`Modal`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/modal-login-error-captcha.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/modal-login-error-captcha.prompt.txt`
