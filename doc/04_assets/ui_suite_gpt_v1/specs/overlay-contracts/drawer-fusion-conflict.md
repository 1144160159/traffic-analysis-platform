...
- ID：`drawer-fusion-conflict`
- 宿主路由：`/fusion`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-fusion-conflict.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-fusion-conflict.prompt.txt`
