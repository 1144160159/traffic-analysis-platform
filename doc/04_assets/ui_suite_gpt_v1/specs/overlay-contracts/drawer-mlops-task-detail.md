...
- ID：`drawer-mlops-task-detail`
- 宿主路由：`/mlops`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-mlops-task-detail.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-mlops-task-detail.prompt.txt`
...
- API 继承：`/api/v1/mlops/status`、`/api/v1/mlops/conditions`
