...
- 宿主路由：`/attack-chains`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-attack-chain-detail.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-attack-chain-detail.prompt.txt`
