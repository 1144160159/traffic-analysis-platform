...
- 宿主路由：`/settings`
- 推荐组件：`Popconfirm`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/popconfirm-settings-token-revoke.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/popconfirm-settings-token-revoke.prompt.txt`
