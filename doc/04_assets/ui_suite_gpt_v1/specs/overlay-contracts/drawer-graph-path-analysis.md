...
- 宿主路由：`/graph`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-graph-path-analysis.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-graph-path-analysis.prompt.txt`
