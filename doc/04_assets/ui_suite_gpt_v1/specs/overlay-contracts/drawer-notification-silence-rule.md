...
- 宿主路由：`/notifications`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-notification-silence-rule.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-notification-silence-rule.prompt.txt`
