...
- 宿主路由：`/topics`
- 推荐组件：`Dropdown/Menu`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/dropdown-topic-share-favorite.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/dropdown-topic-share-favorite.prompt.txt`
