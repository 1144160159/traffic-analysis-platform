...
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-encrypted-fingerprint.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-encrypted-fingerprint.prompt.txt`
...
- API 继承：`/api/v1/encrypted-traffic/stats`、`/api/v1/encrypted-traffic/sessions`、`/api/v1/encrypted-traffic/ja3`、`/api/v1/encrypted-traffic/tunnels`、`/api/v1/encrypted-traffic/exfiltration`
