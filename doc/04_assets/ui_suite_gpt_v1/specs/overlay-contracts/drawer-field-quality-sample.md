...
- ID：`drawer-field-quality-sample`
- 宿主路由：`/data-quality`
- 推荐组件：`Drawer`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/drawer-field-quality-sample.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/drawer-field-quality-sample.prompt.txt`
