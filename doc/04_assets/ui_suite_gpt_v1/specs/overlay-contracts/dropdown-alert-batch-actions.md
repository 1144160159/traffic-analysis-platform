...
- 宿主路由：`/alerts`
- 推荐组件：`Dropdown/Menu`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/overlays/dropdown-alert-batch-actions.png`
- Prompt：`doc/04_assets/ui_suite_gpt_v1/prompts/dropdown-alert-batch-actions.prompt.txt`
