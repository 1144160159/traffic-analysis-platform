...
- 路由：`/playbooks`
- 领域：`detection-ops`
- React 页面：`PlaybookAutomationPage`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/playbooks.png`
- API：`/api/v1/playbooks/catalog`、`/api/v1/playbooks/executions`
...
- `modal-playbook-edit`：剧本编辑，Modal
