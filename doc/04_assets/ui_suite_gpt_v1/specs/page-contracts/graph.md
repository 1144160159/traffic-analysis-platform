...
- 路由：`/graph`
- 领域：`asset-graph`
- React 页面：`GraphEntityPage`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/graph.png`
- API：`/api/v1/graph/explore`
...
- `drawer-graph-entity`：图谱实体详情，Drawer
- `drawer-graph-path-analysis`：图谱路径分析，Drawer
