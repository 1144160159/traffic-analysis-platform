...
- 路由：`/screen`
- 领域：`overview`
- React 页面：`SituationalScreen`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/screen.png`
- API：`/api/v1/dashboard/stats`、`/api/v1/dashboard/encrypted/trend`、`/api/v1/dashboard/attack-phases`
...
- `modal-screen-readonly-token`：态势大屏只读令牌/脱敏配置，Modal
