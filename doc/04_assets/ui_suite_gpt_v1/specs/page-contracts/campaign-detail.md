...
- ID：`campaign-detail`
- 路由：`/campaigns/:campaignId`
- 领域：`threat-analysis`
- React 页面：`CampaignDetailPage`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/campaign-detail.png`
...
- `modal-campaign-report-export`：战役报告导出，Modal
