...
- 路由：`/audit-log`
- 领域：`audit-config`
- React 页面：`AuditLogPage`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/audit-log.png`
...
- `drawer-audit-operation-detail`：审计操作详情，Drawer
- `modal-audit-export`：审计材料导出，Modal
