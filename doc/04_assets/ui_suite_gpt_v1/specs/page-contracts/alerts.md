...
- 路由：`/alerts`
- 领域：`threat-analysis`
- React 页面：`AlertTriagePage`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/alerts.png`
- API：`/api/v1/alerts`
...
- `modal-alert-batch`：告警批量操作确认，Modal
- `dropdown-alert-batch-actions`：告警批量操作下拉，Dropdown/Menu
- `dropdown-alert-row-actions`：告警行操作下拉，Dropdown/Menu
