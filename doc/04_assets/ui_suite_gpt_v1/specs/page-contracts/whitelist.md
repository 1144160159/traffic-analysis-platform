...
- 路由：`/whitelist`
- 领域：`detection-ops`
- React 页面：`WhitelistGovernancePage`
- 目标图：`doc/04_assets/ui_suite_gpt_v1/screens/pages/whitelist.png`
- API：`/api/v1/whitelist`
...
- `modal-whitelist-add`：添加白名单，Modal
- `drawer-whitelist-approval`：白名单审批详情，Drawer
