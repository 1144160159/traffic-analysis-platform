...
def main() -> int:
    ...
    manifest = {
        ...
        "coverage_status": "PARTIAL_OWNED_REAL_POSTGRES_REDPANDA_AND_LOOPBACK_HTTP_PROVIDER_G1",
        ...
        "proven": [
            ...
            "a real loopback HTTP provider validates execution and compensation metadata stable idempotency keys durable confirmed receipts and lost-response ambiguity",
