...
def main() -> int:
    ...
    manifest = {
        ...
        "coverage_status": "PARTIAL_CANONICAL_FEATURE_OWNER_FORMAL_CONTRACT_AND_READ_ONLY_RUNTIME_ADOPTION_INVENTORY",
        ...
        "gate_status": {
            "G0": "PASS",
            "G1": "PASS_FOR_CANONICAL_OWNER_HASH_AND_EXPLICIT_CONTRACT_GAP_REGISTRY" if scoped_pass else "FAIL",
        ...
        "proven": [
            ...
            "all 24 existing formal contracts are hash-bound and pass current semantic validation",
            "all 16 P0 feature contracts are present",
            "asset topic and alert pilot contracts are present",
            "14 standard-scope and 16 backlog contract gaps cannot be hidden",
