...
def main() -> int:
    ...
    manifest = {
        ...
        "coverage_status": "PARTIAL_OWNED_REAL_POSTGRES_ASSIGNMENT_PIPELINE_WITH_FAKE_CLICKHOUSE_AUTHORITY_G1",
        ...
        "open": [
            ...
            "implement and verify compensation for only items whose resulting revision still equals the batch revision",
