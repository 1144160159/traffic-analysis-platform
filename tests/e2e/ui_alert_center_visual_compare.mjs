...
const actualPath = path.join(root, 'evidence/ui-image-breakdowns/pages/alerts/interaction-r801.png');
const comparisonPath = path.join(root, 'evidence/ui-image-breakdowns/pages/alerts/comparison-r801.png');
const diffPath = path.join(root, 'evidence/ui-image-breakdowns/pages/alerts/diff-r801.png');
const metricsPath = path.join(root, 'evidence/ui-image-breakdowns/pages/alerts/metrics-r801.json');
const threshold = 64;
